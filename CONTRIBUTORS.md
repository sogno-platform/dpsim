...
This list is based on deduplicated commit authors and highlights main contributors.
For a complete, automatically updated list use the command `git shortlog -sne`.
