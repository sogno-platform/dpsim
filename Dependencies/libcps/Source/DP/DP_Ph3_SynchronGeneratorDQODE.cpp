...
void DP::Ph3::SynchronGeneratorDQODE::MnaPreStep::execute(Real time, Int timeStepCount) {
...
void DP::Ph3::SynchronGeneratorDQODE::ODEPreStep::execute(Real time, Int timeStepCount) {
	mSynGen.odePreStep();
}
...
void DP::Ph3::SynchronGeneratorDQODE::odeStateSpace(double t, const double y[], double ydot[]) {
