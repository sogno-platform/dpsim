...
For modeling these components resistive companion method is used. Each dynamic component is transformed into a DC equivalent circuit, which represent one iteration of an integration method.
...
\begin{bmatrix}
	& \cdots & \cdots \\
	\cdots & \frac{1}{R_L} & \frac{-1}{R_L} & \cdots \\
	\cdots & \frac{-1}{R_L} & \frac{1}{R_L} & \cdots \\
	& \cdots & \cdots
\end{bmatrix}
\cdot
