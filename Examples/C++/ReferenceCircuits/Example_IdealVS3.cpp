...
void main() {	
	...
	circElements.push_back(make_shared<IdealVoltageSource>("v_1", 1, 0, Complex(10, 0)));
	circElements.push_back(make_shared<ResistorDP>("r_1", 1, 2, 1));
	circElements.push_back(make_shared<ResistorDP>("r_2", 2, 0, 1));
	circElements.push_back(make_shared<ResistorDP>("r_3", 2, 3, 1));
	circElements.push_back(make_shared<ResistorDP>("r_4", 3, 0, 1));
	circElements.push_back(make_shared<ResistorDP>("r_5", 3, 4, 1));
	circElements.push_back(make_shared<IdealVoltageSource>("v_2", 4, 0, Complex(20, 0)));
