...
int main(int argc, char* argv[])
{
	...
	circElements.push_back(std::make_shared<Components::DP::Capacitor>("c_1", 1, 2, 0.001));
	circElements.push_back(std::make_shared<Components::DP::Inductor>("l_1", 2, 0, 0.001));
