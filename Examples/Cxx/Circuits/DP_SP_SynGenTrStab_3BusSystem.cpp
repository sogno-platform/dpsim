...
void SP_1ph_SynGenTrStab_Fault(Real timeStep, Real finalTime, bool startFaultEvent, bool endFaultEvent, Real startTimeFault, Real endTimeFault){
	...
	String simNamePF = "SP_PFinit_3BusSystem";
	...
	gen1PF->modifyPowerFlowBusType(PowerflowBusType::VD);
	...
	loadPF->setParameters(activePower_L, reactivePower_L, Vnom);
	...
	// ----- Dynamic simulation ------
	String simNameSP = "SP_1ph_3BusSystem";
	...
	auto systemSP = SystemTopology(60,
			...
			SystemComponentList{gen1SP, gen2SP, loadSP, faultSP, line12SP, line13SP, line23SP});
	...
	loggerSP->addAttribute("delta_gen1", gen1SP->attribute("Ep_phase"));
	...
	loggerSP->addAttribute("delta_gen2", gen2SP->attribute("Ep_phase"));
...
void DP_1ph_SynGenTrStab_Fault(Real timeStep, Real finalTime, bool startFaultEvent, bool endFaultEvent, Real startTimeFault, Real endTimeFault) {
	...
	Real timeStepPF = finalTime;
	Real finalTimePF = finalTime+timeStepPF;
	String simNamePF = "DP_PFinit_3BusSystem";
	Logger::setLogDir("logs/" + simNamePF);
	...
	// ----- Dynamic simulation ------
	String simNameDP = "DP_1ph_3BusSystem";
	...
	auto systemDP = SystemTopology(60,
			...
			SystemComponentList{gen1DP, gen2DP, loadDP, faultDP, line12DP, line13DP, line23DP});
	...
	loggerDP->addAttribute("delta_gen1", gen1DP->attribute("Ep_phase"));
	...
	loggerDP->addAttribute("delta_gen2", gen2DP->attribute("Ep_phase"));
