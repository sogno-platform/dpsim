...
void DP_1ph_SynGenTrStab_Fault(String simName, Real timeStep, Real finalTime, Real H,
	...
	// Components
	auto genDP = DP::Ph1::SynchronGenerator3OrderVBR::make("SynGen", Logger::Level::debug);
...
int main(int argc, char* argv[]) {	
	...
	std::string simName = "DP_SynGen3OrderVBR_SMIB_Fault" + rfault_str + stepSize_str + faultLength_str;
