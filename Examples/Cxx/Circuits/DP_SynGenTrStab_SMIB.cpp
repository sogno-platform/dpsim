...
void DP_1ph_SynGenTrStab_Fault(String simName, Real timeStep, Real finalTime, bool startFaultEvent, bool endFaultEvent, Real startTimeFault, Real endTimeFault) {
	...
	// Logging
	auto logger = DataLogger::make(simNameDP);
...
int main(int argc, char* argv[]) {	
	...
	DP_1ph_SynGenTrStab_Fault(simName, timeStep, finalTime,startFaultEvent, endFaultEvent, startTimeFault, endTimeFault);
}