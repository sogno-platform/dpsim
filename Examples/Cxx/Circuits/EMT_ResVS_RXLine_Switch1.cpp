...
int main(int argc, char* argv[])
{
	...
	fileName << "RxLineResLoad_EMT_" << timeStep;
	Component::Base::List circElements0, circElements1, circElements2;
	circElements0.push_back(std::make_shared<Component::EMT::VoltageSource>("v_s", 1, 0, Complex(10000, 0), 1));
	...
	circElements1.push_back(std::make_shared<Component::EMT::Resistor>("r_load", 3, 0, 1000));
	circElements2.push_back(std::make_shared<Component::EMT::Resistor>("r_load", 3, 0, 800));
