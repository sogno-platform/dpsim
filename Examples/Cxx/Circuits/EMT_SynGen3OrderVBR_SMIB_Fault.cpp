...
void EMT_3ph_SynGenTrStab_SteadyState(String simName, Real timeStep, Real finalTime, Real H,
	...
	auto genEMT = EMT::Ph3::SynchronGenerator3OrderVBR::make("SynGen", Logger::Level::debug);
...
int main(int argc, char* argv[]) {	
	...
	std::string simName ="EMT_SynGen3OrderVBR_SMIB_Fault" + rfault_str + faultLength_str + stepSize_str;
