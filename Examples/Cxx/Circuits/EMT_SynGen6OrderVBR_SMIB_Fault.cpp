...
void EMT_3ph_SynGenTrStab_SteadyState(String simName, Real timeStep, Real finalTime, Real H,
	...
	auto genEMT = EMT::Ph3::SynchronGenerator6aOrderVBR::make("SynGen", Logger::Level::debug);
	...
	//loggerEMT->addAttribute("Edq0_t", 	genEMT->attribute("Edq0_t"));
	//loggerEMT->addAttribute("Edq0_s", 	genEMT->attribute("Edq0_s"));
...
int main(int argc, char* argv[]) {	
	...
	std::string simName ="EMT_SynGen6OrderVBR_SMIB_Fault" + rfault_str + faultLength_str + stepSize_str  + inertia_str;
