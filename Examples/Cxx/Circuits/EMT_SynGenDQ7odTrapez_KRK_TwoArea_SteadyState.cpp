...
void EMT_SynGenDQ7odTrapez_KRK_TwoArea_SteadyState(String simName, Real timeStep, Real finalTime, bool startFaultEvent, bool endFaultEvent, Real startTimeFault, Real endTimeFault, Real cmdInertia_G1, Real cmdInertia_G2, Real cmdInertia_G3, Real cmdInertia_G4, Real cmdDamping_G1, Real cmdDamping_G2, Real cmdDamping_G3, Real cmdDamping_G4) {
	...
	// setPointVoltage is defined as the voltage at the transfomer primary side and should be transformed to network side
	gen2PF->setParameters(KRK_TwoArea.nomPower_G2, KRK_TwoArea.nomPhPhVoltRMS_G2, KRK_TwoArea.initActivePower_G2, KRK_TwoArea.setPointVoltage_G2*KRK_TwoArea.t2_ratio, PowerflowBusType::PV, KRK_TwoArea.initReactivePower_G2);
	...
	// setPointVoltage is defined as the voltage at the transfomer primary side and should be transformed to network side
	gen3PF->setParameters(KRK_TwoArea.nomPower_G3, KRK_TwoArea.nomPhPhVoltRMS_G3, KRK_TwoArea.initActivePower_G3, KRK_TwoArea.setPointVoltage_G3*KRK_TwoArea.t3_ratio, PowerflowBusType::VD, KRK_TwoArea.initReactivePower_G3);
	...
	// Components
	auto gen1EMT = EMT::Ph3::SynchronGeneratorDQTrapez::make("SynGen1", Logger::Level::debug);
	gen1EMT->setParametersOperationalPerUnit(
		KRK_TwoArea.nomPower_G1, KRK_TwoArea.nomPhPhVoltRMS_G1, KRK_TwoArea.nomFreq_G1, KRK_TwoArea.poleNum, KRK_TwoArea.nomFieldCurr,
		Rs, Ld, Lq, Ld_t, Lq_t, Ld_s,
		Lq_s, Ll, Td0_t, Tq0_t, Td0_s, Tq0_s, KRK_TwoArea.H_G1);
	...
	// gen1EMT->setInitialValues(initApparentPower_G1, KRK_TwoArea.initMechPower_G1);

	// Synchronous generator 2
	auto gen2EMT = EMT::Ph3::SynchronGeneratorDQTrapez::make("SynGen2", Logger::Level::debug);
	gen2EMT->setParametersOperationalPerUnit(
		KRK_TwoArea.nomPower_G2, KRK_TwoArea.nomPhPhVoltRMS_G2, KRK_TwoArea.nomFreq_G2, KRK_TwoArea.poleNum, KRK_TwoArea.nomFieldCurr,
		Rs, Ld, Lq, Ld_t, Lq_t, Ld_s,
		Lq_s, Ll, Td0_t, Tq0_t, Td0_s, Tq0_s, KRK_TwoArea.H_G2);
	// Extract relevant powerflow results
	...
	// gen2EMT->setInitialValues(initApparentPower_G2, KRK_TwoArea.initMechPower_G2);

	//Synchronous generator 3
	auto gen3EMT = EMT::Ph3::SynchronGeneratorDQTrapez::make("SynGen3", Logger::Level::debug);
	gen3EMT->setParametersOperationalPerUnit(
		KRK_TwoArea.nomPower_G3, KRK_TwoArea.nomPhPhVoltRMS_G3, KRK_TwoArea.nomFreq_G3, KRK_TwoArea.poleNum, KRK_TwoArea.nomFieldCurr,
		Rs, Ld, Lq, Ld_t, Lq_t, Ld_s,
		Lq_s, Ll, Td0_t, Tq0_t, Td0_s, Tq0_s, KRK_TwoArea.H_G3);
	// Extract relevant powerflow results
	...
	// gen3EMT->setInitialValues(initApparentPower_G3, KRK_TwoArea.initMechPower_G3);

	//Synchronous generator 4
	auto gen4EMT = EMT::Ph3::SynchronGeneratorDQTrapez::make("SynGen4", Logger::Level::debug);
	gen4EMT->setParametersOperationalPerUnit(
		KRK_TwoArea.nomPower_G4, KRK_TwoArea.nomPhPhVoltRMS_G4, KRK_TwoArea.nomFreq_G4, KRK_TwoArea.poleNum, KRK_TwoArea.nomFieldCurr,
		Rs, Ld, Lq, Ld_t, Lq_t, Ld_s,
		Lq_s, Ll, Td0_t, Tq0_t, Td0_s, Tq0_s, KRK_TwoArea.H_G4);
	// Extract relevant powerflow results
	...
	// gen4EMT->setInitialValues(initApparentPower_G4, KRK_TwoArea.initMechPower_G4);
	...
	// load7EMT_c->connect({ n7EMT });
	// load9EMT_c->connect({ n9EMT });
	...
	loggerEMT->addAttribute("v_load7", load7EMT->attribute("v_intf"));
	loggerEMT->addAttribute("i_load7", load7EMT->attribute("i_intf"));
	loggerEMT->addAttribute("v_load9", load9EMT->attribute("v_intf"));
	loggerEMT->addAttribute("i_load9", load9EMT->attribute("i_intf"));
...
int main(int argc, char* argv[]) {
	...
	String simName="EMT_SynGenDQ7odTrapez_KRK_TwoArea_SteadyState";
	Real finalTime = 30;
	Real timeStep = 50e-6;
	...
	EMT_SynGenDQ7odTrapez_KRK_TwoArea_SteadyState(simName, timeStep, finalTime, startFaultEvent, endFaultEvent, startTimeFault, endTimeFault, cmdInertia_G1, cmdInertia_G2, cmdInertia_G3, cmdInertia_G4, cmdDamping_G1, cmdDamping_G2, cmdDamping_G3, cmdDamping_G4);
}
