...
int main(int argc, char* argv[]) {
	String simName = "SP_Slack_PiLine_PQLoad_FM_with_PF_Init";
	...
	if (argc > 1) {
		...
		if (args.options.find("zigzag") != args.options.end()) {
			...
			simName = "SP_Slack_PiLine_PQLoad_FMzz_with_PF_Init";
		}
	}
	...
	extnetSP->setParameters(Complex(Vnom,0), 1.25, 1.25, -1.25, zigzag);
