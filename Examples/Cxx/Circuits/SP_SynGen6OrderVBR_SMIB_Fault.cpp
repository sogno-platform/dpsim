...
void SP_1ph_SynGenTrStab_Fault(String simName, Real timeStep, Real finalTime, Real H,
	...
	// Components
	auto genSP = SP::Ph1::SynchronGenerator6aOrderVBR::make("SynGen", Logger::Level::debug);
...
int main(int argc, char* argv[]) {	
	...
	std::string simName = "SP_SynGen6OrderVBR_SMIB_Fault" + rfault_str + stepSize_str + faultLength_str;
