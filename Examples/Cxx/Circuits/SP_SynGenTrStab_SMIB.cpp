...
Real nomFreq = 60;
Real H = 5;
//Real Xpd=0.3+0.1; //in p.u
//Real Xpd=0.31; //in p.u with Generator nominal voltage & Power as base
//Real Xpd=0.0028; //in p.u with network voltage level & Generator nominal power as base
Real Xpd=0.31;
Real Rs = 0.003*0;
Real Kd = 1;
...
void SP_1ph_SynGenTrStab_Fault(String simName, Real timeStep, Real finalTime, bool startFaultEvent, bool endFaultEvent, Real startTimeFault, Real endTimeFault){
	...
	// Logging
	auto logger = DataLogger::make(simNameSP);
...
int main(int argc, char* argv[]) {		
	...
	SP_1ph_SynGenTrStab_Fault(simName, timeStep, finalTime,startFaultEvent, endFaultEvent, startTimeFault, endTimeFault);
}