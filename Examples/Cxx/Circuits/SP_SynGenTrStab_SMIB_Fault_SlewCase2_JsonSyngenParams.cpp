...
int main(int argc, char* argv[]) {
	...
	genSP->setStandardParametersPU(smib.nomPower, smib.nomPhPhVoltRMS, smib.nomFreq, smib.Xpd*std::pow(smib.t_ratio,2), smib.H, smib.Rs, 0 );
	DPsim::Utils::applySynchronousGeneratorParametersFromJson(simConfig, genSP);
