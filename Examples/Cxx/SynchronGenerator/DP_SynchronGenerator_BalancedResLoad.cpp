...
int main(int argc, char* argv[])
{
	...
	Component::Base::Ptr r1 = std::make_shared<Component::DP::Resistor>("r1", 0, 1, loadRes);
	Component::Base::Ptr r2 = std::make_shared<Component::DP::Resistor>("r2", 0, 2, loadRes);
	Component::Base::Ptr r3 = std::make_shared<Component::DP::Resistor>("r3", 0, 3, loadRes);
