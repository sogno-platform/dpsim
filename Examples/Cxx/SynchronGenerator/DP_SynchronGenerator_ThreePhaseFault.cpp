...
int main(int argc, char* argv[])
{
	...
	Component::Base::Ptr gen = std::make_shared<Component::DP::SynchronGenerator>("gen", 1, 2, 3,
		nomPower, nomPhPhVoltRMS, nomFreq, poleNum, nomFieldCurr,
		Rs, Ll, Lmd, Lmd0, Lmq, Lmq0, Rfd, Llfd, Rkd, Llkd, Rkq1, Llkq1, Rkq2, Llkq2, H);
	Real loadRes = 1037.8378;
	Component::Base::Ptr r1 = std::make_shared<Component::DP::Resistor>("r1", 1, 0, loadRes);
	Component::Base::Ptr r2 = std::make_shared<Component::DP::Resistor>("r2", 2, 0, loadRes);
	Component::Base::Ptr r3 = std::make_shared<Component::DP::Resistor>("r3", 3, 0, loadRes);
	...
	Component::Base::Ptr rBreaker1 = std::make_shared<Component::DP::Resistor>("rbreak1", 1, 0, breakerRes);
	Component::Base::Ptr rBreaker2 = std::make_shared<Component::DP::Resistor>("rbreak2", 2, 0, breakerRes);
	Component::Base::Ptr rBreaker3 = std::make_shared<Component::DP::Resistor>("rbreak3", 3, 0, breakerRes);
	...
	auto genPtr = std::dynamic_pointer_cast<Component::DP::SynchronGenerator>(gen);
