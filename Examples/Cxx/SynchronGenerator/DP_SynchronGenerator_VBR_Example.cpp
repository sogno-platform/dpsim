...
int main(int argc, char* argv[])
{
	...
	Components::Base::Ptr gen = SynchronGeneratorVBRNew::make("gen", 0, 1, 2,
	...
	Int downSampling = 1;
	Simulation sim("DP_SynGen_VBR", comps, om, dt, tf, Logger::Level::INFO, SimulationType::DynPhasor, downSampling);
