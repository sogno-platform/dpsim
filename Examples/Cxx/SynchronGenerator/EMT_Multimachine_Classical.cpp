...
int main(int argc, char* argv[])
{
		...
		// Declare circuit components
		Component::Ptr gen2 = SynchronGenerator::make("gen2", 6, 7, 8,
				nomPower, nomPhPhVoltRMS, nomFreq, poleNum, nomFieldCurr,
				Rs, Ll, Lmd, Lmd0, Lmq, Lmq0, Rfd, Llfd, Rkd, Llkd, Rkq1, Llkq1, Rkq2, Llkq2, H, Ra, Logger::Level::INFO);
		...
		//Load
		Component::Ptr r1 = Resistor::make("r1", 3, GND, loadRes);
		Component::Ptr r2 = Resistor::make("r2", 4, GND, loadRes);
		Component::Ptr r3 = Resistor::make("r3", 5, GND, loadRes);
		...
		//Line Resistance2
		Component::Ptr LineR12 = Resistor::make("LineR12", 3, 6, lineRes);
		Component::Ptr LineR22 = Resistor::make("LineR22", 4, 7, lineRes);
		Component::Ptr LineR32 = Resistor::make("LineR32", 5, 8, lineRes);
		...
		Component::List comps = { gen,  gen2, r1, r2, r3 , LineR1, LineR2, LineR3, LineR12, LineR22, LineR32 };

		// Declare circuit components for resistance change
		Real breakerRes = 0.96 + 0.0001;
		Component::Ptr rBreaker1 = Resistor::make("rbreak1", 3, GND, breakerRes);
		Component::Ptr rBreaker2 = Resistor::make("rbreak2", 4, GND, breakerRes);
		Component::Ptr rBreaker3 = Resistor::make("rbreak3", 5, GND, breakerRes);
		...
		Component::List compsBreakerOn = { gen,  gen2, r1, r2, r3 , LineR1, LineR2, LineR3, LineR12, LineR22, LineR32, rBreaker1, rBreaker2, rBreaker3 };
