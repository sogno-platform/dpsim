...
voltageDP = csvread('../../../vsa/Results/ABCFault/DPsim/DP/Dq/DP_SynchronGenerator_Dq_0.000050_LeftVector.csv',1);
%currentDP = csvread('../../../vsa/Results/LoadChange/DPsim/DP/DP_SynchronGenerator_Dq_RightVector.csv',1);
Log_SynGen = csvread('../../../vsa/Results/ABCFault/DPsim/DP/Dq/SynGen_Dq_0.000050.csv',1);
