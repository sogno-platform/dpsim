...
VoltageVector = csvread('../../vsa/Results/SynGenVbrEmt_ABCFault_DPsim_1_Damping/0.000001/data_vt.csv');
CurrentVector = csvread('../../vsa/Results/SynGenVbrEmt_ABCFault_DPsim_1_Damping/0.000001/data_j.csv');
