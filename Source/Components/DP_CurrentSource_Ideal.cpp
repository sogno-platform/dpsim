...
Component::DP::CurrentSourceIdeal::CurrentSourceIdeal(String name, Int src, Int dest, Complex current) : Base(name, src, dest) {
...
void Component::DP::CurrentSourceIdeal::setCurrent(Real real, Real imag) {
