...
void Components::DP::SynchronGeneratorVBR::CalculateAuxiliarConstants(Real dt) {
...
void Components::DP::SynchronGeneratorVBR::CalculateAuxiliarVariables(Real time) {
