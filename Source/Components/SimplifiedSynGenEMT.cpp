...
#include "SimplifiedSynGenEMT.h"
#include "../IntegrationMethod.h"

using namespace DPsim;


SimplifiedSynGenEMT::SimplifiedSynGenEMT(String name, Int node1, Int node2, Int node3,
	...
	va = IdealVoltageSourceEMT("va", 0, 1, mVa);
	vb = IdealVoltageSourceEMT("vb", 0, 2, mVb);
	vc = IdealVoltageSourceEMT("vc", 0, 3, mVc);
...
SimplifiedSynGenEMT::~SimplifiedSynGenEMT() {
	if (mLogActive) {
		delete mLog;
	}
}
...
void SimplifiedSynGenEMT::init(Real om, Real dt,
...
void SimplifiedSynGenEMT::applySystemMatrixStamp(SystemModel& system) {
...
void SimplifiedSynGenEMT::applyRightSideVectorStamp(SystemModel& system) {
...
void SimplifiedSynGenEMT::stepInPerUnit(Real om, Real dt, Real time, NumericalMethod numMethod) {
...
void SimplifiedSynGenEMT::postStep(SystemModel& system) {
	if (mNode1 >= 0) {
...
Matrix SimplifiedSynGenEMT::parkTransform2(Real theta, Real a, Real b, Real c) {
...
Matrix SimplifiedSynGenEMT::inverseParkTransform2(Real theta, Real d, Real q, Real zero) {
