...
namespace DPsim {
	...
	protected:
		...
		// ### Useful Matrices ###
		/// inductance matrix
		DPSMatrix mInductanceMat;
		/// resistance matrix
		DPSMatrix mResistanceMat;
		/// reactance matrix
		DPSMatrix mReactanceMat;
		/// omega - flux matrix
		DPSMatrix mOmegaFluxMat;
		/// matrix for reversing stator current directions in calculations with respect to other currents
		DPSMatrix mReverseCurrents;
	...
	public:
		...
		SynchGenBase(std::string name, int node1, int node2, int node3,
