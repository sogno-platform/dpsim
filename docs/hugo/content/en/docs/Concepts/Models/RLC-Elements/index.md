---
title: "RLC-Elements"
aliases: ["/docs/models/rlc-elements/"]
...
Hence, the vector of unknowns $\boldsymbol{x}$ and the source vector $\boldsymbol{b}$ become time dependent and this leads to the system description:
