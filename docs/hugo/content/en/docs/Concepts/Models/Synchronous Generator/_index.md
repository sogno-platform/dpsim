...
aliases: ["/docs/models/synchronous-generator/"]
...
Reduced order machines from third to sixth order are derived under
[reduced order machine models]({{< ref "reduced-order.md" >}}). How any of these are stamped into
the solver is covered under
[reduced order generator implementation]({{< ref "/docs/Developer Guide/Model Implementations/reduced-order-generator.md" >}}).
