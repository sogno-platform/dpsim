---
title: "Attributes"
aliases: ["/docs/overview/attributes/"]
...
are the logger methods (e.g. `DataLogger::logAttribute`) and [interface]({{< ref "/docs/User Guide/co-simulation.md" >}}) methods (e.g. `InterfaceVillas::exportAttribute`). To obtain the
