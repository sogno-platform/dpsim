...
aliases: ["/docs/overview/mnainterface/"]
...
Much like the `CompositePowerComp` class for [Composite Components]({{< ref "/docs/Developer Guide/Writing a Model/subcomponents.md" >}}), the `MNASimPowerComp` class
