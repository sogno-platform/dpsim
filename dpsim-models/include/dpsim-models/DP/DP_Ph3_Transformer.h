...
private:
  ...
  std::shared_ptr<DP::Ph3::Resistor> mSubResistor2;
  std::shared_ptr<DP::Ph3::Inductor> mSubInductor;
  std::shared_ptr<DP::Ph3::Inductor> mSubInductor2;
  std::shared_ptr<DP::Ph3::Resistor> mSubMagnetizingResistor;
  std::shared_ptr<DP::Ph3::Inductor> mSubMagnetizingInductor;
