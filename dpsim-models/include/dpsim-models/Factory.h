...
template <class BaseClass> class Creator {
  ...
  void registerSynchronGenerators() {
    FactoryRegistration<CPS::SP::Ph1::ReducedOrderSynchronGeneratorVBR>
        _3OrderSP(
            "3",
            new DerivedCreator<CPS::SP::Ph1::SynchronGenerator3OrderVBR,
                               CPS::SP::Ph1::ReducedOrderSynchronGeneratorVBR>);
    FactoryRegistration<CPS::SP::Ph1::ReducedOrderSynchronGeneratorVBR>
        _4OrderSP(
            "4",
            new DerivedCreator<CPS::SP::Ph1::SynchronGenerator4OrderVBR,
                               CPS::SP::Ph1::ReducedOrderSynchronGeneratorVBR>);
    FactoryRegistration<CPS::SP::Ph1::ReducedOrderSynchronGeneratorVBR>
        _5OrderSP(
            "5",
            new DerivedCreator<CPS::SP::Ph1::SynchronGenerator5OrderVBR,
                               CPS::SP::Ph1::ReducedOrderSynchronGeneratorVBR>);
    FactoryRegistration<CPS::SP::Ph1::ReducedOrderSynchronGeneratorVBR>
        _6aOrderSP(
            "6a",
  ...
  void registerSynchronGenerators() {
    FactoryRegistration<CPS::DP::Ph1::ReducedOrderSynchronGeneratorVBR>
        _3OrderSP(
            "3",
            new DerivedCreator<CPS::DP::Ph1::SynchronGenerator3OrderVBR,
                               CPS::DP::Ph1::ReducedOrderSynchronGeneratorVBR>);
    FactoryRegistration<CPS::DP::Ph1::ReducedOrderSynchronGeneratorVBR>
        _4OrderSP(
            "4",
            new DerivedCreator<CPS::DP::Ph1::SynchronGenerator4OrderVBR,
                               CPS::DP::Ph1::ReducedOrderSynchronGeneratorVBR>);
