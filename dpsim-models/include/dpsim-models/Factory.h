  ...
  private:
    ...
    void registerExciters() {
      FactoryRegistration<CPS::Base::Exciter> _ExciterDC1(
          "DC1",
          new DerivedCreator<CPS::Signal::ExciterDC1, CPS::Base::Exciter>);
