...
protected:
  ...
  Real mInternalParallelResistance = 1e9;

  std::shared_ptr<DP::SimNode> mNode1, mNode2, mVirtualNode;
...
public:
  ...
  public:
    PreStep(DecouplingIdealTransformer_DP_Ph1 &itm)
  ...
  private:
    DecouplingIdealTransformer_DP_Ph1 &mITM;
  };
