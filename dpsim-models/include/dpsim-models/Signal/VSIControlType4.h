...
namespace Signal {
    ...
    class VSIControlType4Parameters :
		public Base::VSIControlParameters,
		public SharedFactory<VSIControlType4Parameters> {
	...
	/// Ref.: Yazdani
	class VSIControlType4 :
		public SimSignalComp,
        public Base::VSIControlDQ,
		public SharedFactory<VSIControlType4> {

    private:
        /// Controller Parameters
		std::shared_ptr<VSIControlType4Parameters> mParameters;
    ...
    public:
        ///
        explicit VSIControlType4(const String & name, CPS::Logger::Level logLevel) : 
