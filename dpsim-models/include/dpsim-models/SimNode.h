...
namespace CPS {
	...
	public:
		...
		///
		void mnaCompInitializeHarm(std::vector<Attribute<Matrix>::Ptr> leftVector);
		///
	...
	template<>
	void SimNode<Complex>::mnaCompInitializeHarm(std::vector<Attribute<Matrix>::Ptr> leftVector);
