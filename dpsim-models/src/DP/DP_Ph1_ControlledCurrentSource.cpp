...
void DP::Ph1::ControlledCurrentSource::setParameters(Complex currentRef) {
...
void DP::Ph1::ControlledCurrentSource::mnaCompInitialize(
    Real omega, Real timeStep, Attribute<Matrix>::Ptr leftVector) {
  updateMatrixNodeIndices();
  (**mIntfCurrent)(0, 0) = **mCurrentRef;
}

void DP::Ph1::ControlledCurrentSource::updateCurrent(Real time) {
  (**mIntfCurrent)(0, 0) = **mCurrentRef;
...
void DP::Ph1::ControlledCurrentSource::mnaCompAddPreStepDependencies(
...
void DP::Ph1::ControlledCurrentSource::mnaCompApplyRightSideVectorStamp(
    Matrix &rightVector) {
  (**mIntfCurrent)(0, 0) = **mCurrentRef;
...
void DP::Ph1::ControlledCurrentSource::mnaCompAddPostStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes,
...
void DP::Ph1::ControlledCurrentSource::mnaCompPostStep(
