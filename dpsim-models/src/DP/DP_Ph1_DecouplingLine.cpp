...
DP::Ph1::DecouplingLine::DecouplingLine(String uid, String name,
...
void DP::Ph1::DecouplingLine::setParameters(Real resistance, Real inductance,
                                            Real capacitance) {
...
void DP::Ph1::DecouplingLine::createSubComponents() {
  if (mSubCompCreated)
    return;
...
void DP::Ph1::DecouplingLine::initializeParentFromNodesAndTerminals(
    Real frequency) {
  (**mIntfVoltage)(0, 0) = initialSingleVoltage(1) - initialSingleVoltage(0);
}

void DP::Ph1::DecouplingLine::mnaParentInitialize(
...
Complex DP::Ph1::DecouplingLine::interpolate(std::vector<Complex> &data) {
...
void DP::Ph1::DecouplingLine::step(Real time, Int timeStepCount) {
...
void DP::Ph1::DecouplingLine::postStep() {
...
void DP::Ph1::DecouplingLine::mnaParentPreStep(Real time, Int timeStepCount) {
...
void DP::Ph1::DecouplingLine::mnaParentPostStep(
...
void DP::Ph1::DecouplingLine::mnaCompUpdateVoltage(const Matrix &leftVector) {
  (**mIntfVoltage)(0, 0) =
      -mRes2->intfVoltage()(0, 0) + mRes1->intfVoltage()(0, 0);
}

void DP::Ph1::DecouplingLine::mnaCompUpdateCurrent(const Matrix &leftVector) {
  (**mIntfCurrent)(0, 0) = -mRes1->intfCurrent()(0, 0) + mSrcCur1->get();
}

void DP::Ph1::DecouplingLine::mnaParentAddPreStepDependencies(
...
void DP::Ph1::DecouplingLine::mnaParentAddPostStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes,
