...
void DP::Ph1::SynchronGenerator4OrderPCM::specificInitialization() {
  ...
  SPDLOG_LOGGER_DEBUG(mSLog,
                      ...
                      (**mEdq_t)(0, 0), (**mEdq_t)(1, 0), mMaxIter, mTolerance);
  mSLog->flush();
...
void DP::Ph1::SynchronGenerator4OrderPCM::stepInPerUnit() {
  ...
  **mNumIter = 0;
  ...
  (**mEdq_t) = Math::StateSpaceEuler(**mEdq_t, mAStateSpace, mBStateSpace,
                                     mCStateSpace * **mEf, mTimeStep, **mVdq);
...
void DP::Ph1::SynchronGenerator4OrderPCM::mnaCompApplyRightSideVectorStamp(
    Matrix &rightVector) {
...
void DP::Ph1::SynchronGenerator4OrderPCM::correctorStep() {
  ...
  **mNumIter = **mNumIter + 1;
  ...
  (**mEdq_t) = Math::applyStateSpaceTrapezoidalMatrices(
      mAdTrapezoidal, mBdTrapezoidal, mCdTrapezoidal * **mEf, mEdqtPrevStep,
      **mVdq, mVdqPrevStep);
...
void DP::Ph1::SynchronGenerator4OrderPCM::updateVoltage(
...
void DP::Ph1::SynchronGenerator4OrderPCM::mnaCompPostStep(
    const Matrix &leftVector) {}
