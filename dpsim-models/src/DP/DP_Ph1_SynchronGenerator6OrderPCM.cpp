...
void DP::Ph1::SynchronGenerator6OrderPCM::specificInitialization() {
  ...
  SPDLOG_LOGGER_INFO(mSLog,
                     ...
                     (**mEdq_t)(0, 0), (**mEdq_t)(1, 0), (**mEdq_s)(0, 0),
                     (**mEdq_s)(1, 0), mMaxIter, mTolerance);
  mSLog->flush();
...
void DP::Ph1::SynchronGenerator6OrderPCM::calculateStateSpaceMatrices() {
  ...
  mAStateSpace << -1. / mTq0_t, 0., 0., 0., 0., -1. / mTd0_t, 0., 0.,
      1. / mTq0_s, 0., -1. / mTq0_s, 0., 0., 1. / mTd0_s, 0., -1. / mTd0_s;
  mBStateSpace << 0., Bd_t, -Bq_t, 0., 0., Bd_s, -Bq_s, 0.;
  mCStateSpace << 0., 1 / mTd0_t, 0., 0.;
...
void DP::Ph1::SynchronGenerator6OrderPCM::stepInPerUnit() {
  ...
  **mNumIter = 0;
  ...
  mEdqts = Math::StateSpaceEuler(mEdqts, mAStateSpace, mBStateSpace,
                                 mCStateSpace * **mEf, mTimeStep, **mIdq);
...
void DP::Ph1::SynchronGenerator6OrderPCM::mnaCompApplyRightSideVectorStamp(
    Matrix &rightVector) {
...
void DP::Ph1::SynchronGenerator6OrderPCM::correctorStep() {
  ...
  **mNumIter = **mNumIter + 1;
  ...
  mEdqts = Math::applyStateSpaceTrapezoidalMatrices(
      mAdTrapezoidal, mBdTrapezoidal, mCdTrapezoidal * **mEf, mEdqtsPrevStep,
      **mIdq, mIdqPrevStep);
...
void DP::Ph1::SynchronGenerator6OrderPCM::updateVoltage(
...
void DP::Ph1::SynchronGenerator6OrderPCM::mnaCompPostStep(
    const Matrix &leftVector) {
