...
void DP::Ph1::SynchronGenerator6aOrderVBR::specificInitialization() {
  ...
  (**mEdq_t)(1, 0) =
      (1 - mTaa / mTd0_t) * (**mEf) - (mLd - mLd_t - mYd) * (**mIdq)(0, 0);
  ...
  mEh_t(1, 0) = mAq_t * (**mIdq)(0, 0) + mBq_t * (**mEdq_t)(1, 0) +
...
void DP::Ph1::SynchronGenerator6aOrderVBR::stepInPerUnit() {
  ...
  mEh_s(0, 0) = mAd_s * (**mIdq)(1, 0) + mBd_s * (**mEdq_t)(0, 0) +
                mCd_s * (**mEdq_s)(0, 0);
  mEh_s(1, 0) = mAq_s * (**mIdq)(0, 0) + mBq_s * (**mEdq_t)(1, 0) +
                mCq_s * (**mEdq_s)(1, 0) + mDq_s * (**mEf) + mDq_s * mEf_prev;
