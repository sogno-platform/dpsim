...
void DP::Ph1::SynchronGeneratorIdeal::createSubComponents() {
  if (mSubCompCreated)
    return;
...
void DP::Ph1::SynchronGeneratorIdeal::mnaParentAddPreStepDependencies(
...
void DP::Ph1::SynchronGeneratorIdeal::mnaParentPreStep(Real time,
                                                       Int timeStepCount) {
  mnaCompApplyRightSideVectorStamp(**mRightVector);
}

void DP::Ph1::SynchronGeneratorIdeal::mnaParentAddPostStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes,
...
void DP::Ph1::SynchronGeneratorIdeal::mnaParentPostStep(
    Real time, Int timeStepCount, Attribute<Matrix>::Ptr &leftVector) {
  mnaCompUpdateCurrent(**leftVector);
  mnaCompUpdateVoltage(**leftVector);
}

void DP::Ph1::SynchronGeneratorIdeal::mnaCompUpdateCurrent(
    const Matrix &leftvector) {
  **mIntfCurrent = **mSubComponents[0]->mIntfCurrent;
}

void DP::Ph1::SynchronGeneratorIdeal::mnaCompUpdateVoltage(
    const Matrix &leftVector) {
