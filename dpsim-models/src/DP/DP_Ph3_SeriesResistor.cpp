...
void DP::Ph3::SeriesResistor::mnaCompInitialize(
    Real omega, Real timeStep, Attribute<Matrix>::Ptr leftVector) {
  updateMatrixNodeIndices();
  **mRightVector = Matrix::Zero(0, 0);
}

void DP::Ph3::SeriesResistor::mnaCompApplySystemMatrixStamp(
...
void DP::Ph3::SeriesResistor::mnaCompAddPostStepDependencies(
...
void DP::Ph3::SeriesResistor::mnaCompPostStep(
