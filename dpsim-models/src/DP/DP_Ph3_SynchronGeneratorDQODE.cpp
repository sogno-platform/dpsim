...
DP::Ph3::SynchronGeneratorDQODE::SynchronGeneratorDQODE(String uid, String name,
                                                        Logger::Level logLevel)
    : SynchronGeneratorDQ(uid, name, logLevel), ODEInterface(mAttributes) {}

DP::Ph3::SynchronGeneratorDQODE::SynchronGeneratorDQODE(String name,
                                                        Logger::Level logLevel)
    : SynchronGeneratorDQ(name, name, logLevel), ODEInterface(mAttributes) {}

void DP::Ph3::SynchronGeneratorDQODE::mnaCompInitialize(
...
void DP::Ph3::SynchronGeneratorDQODE::mnaCompAddPreStepDependencies(
...
void DP::Ph3::SynchronGeneratorDQODE::mnaCompPreStep(Real time,
                                                     Int timeStepCount) {
...
void DP::Ph3::SynchronGeneratorDQODE::ODEPreStep::execute(Real time,
                                                          Int timeStepCount) {
  mSynGen.odePreStep();
}

void DP::Ph3::SynchronGeneratorDQODE::odePostStep() {
  for (int i = 0; i < mDim - 2; i++)
...
void DP::Ph3::SynchronGeneratorDQODE::odeStateSpace(double t, const double y[],
                                                    double ydot[]) {
...
void DP::Ph3::SynchronGeneratorDQODE::odeJacobian(double t, const double y[],
                                                  double fy[], double J[],
