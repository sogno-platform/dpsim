...
EMT::Ph1::DecouplingIdealTransformer::DecouplingIdealTransformer(
...
void EMT::Ph1::DecouplingIdealTransformer::setParameters(
...
void EMT::Ph1::DecouplingIdealTransformer::createSubComponents() {
  if (mSubCompCreated)
    return;
...
void EMT::Ph1::DecouplingIdealTransformer::
...
void EMT::Ph1::DecouplingIdealTransformer::mnaParentInitialize(
...
Real EMT::Ph1::DecouplingIdealTransformer::interpolate(
...
Real EMT::Ph1::DecouplingIdealTransformer::extrapolate(
    std::vector<Real> &data) {
  if (mCouplingMethod == CouplingMethod::EXTRAPOLATION_LINEAR) {
...
void EMT::Ph1::DecouplingIdealTransformer::step(Real time, Int timeStepCount) {
  Real volt1, cur2;
...
void EMT::Ph1::DecouplingIdealTransformer::postStep() {
...
void EMT::Ph1::DecouplingIdealTransformer::mnaParentPreStep(Real time,
                                                            Int timeStepCount) {
...
void EMT::Ph1::DecouplingIdealTransformer::mnaParentPostStep(
...
void EMT::Ph1::DecouplingIdealTransformer::mnaCompUpdateVoltage(
    const Matrix &leftVector) {
  (**mIntfVoltage)(0, 0) = mVoltageSrc->intfVoltage()(0, 0);
}

void EMT::Ph1::DecouplingIdealTransformer::mnaCompUpdateCurrent(
    const Matrix &leftVector) {
  (**mIntfCurrent)(0, 0) = mVoltageSrc->intfCurrent()(0, 0);
}

void EMT::Ph1::DecouplingIdealTransformer::mnaParentAddPreStepDependencies(
...
void EMT::Ph1::DecouplingIdealTransformer::mnaParentAddPostStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes,
