...
void EMT::Ph1::VoltageSourceNorton::mnaCompInitialize(Real omega, Real timeStep, Attribute<Matrix>::Ptr leftVector) {
...
void EMT::Ph1::VoltageSourceNorton::mnaCompApplyRightSideVectorStamp(Matrix& rightVector) {
...
void EMT::Ph1::VoltageSourceNorton::mnaCompAddPreStepDependencies(AttributeBase::List &prevStepDependencies, AttributeBase::List &attributeDependencies, AttributeBase::List &modifiedAttributes) {
	attributeDependencies.push_back(mVoltageRef);
	modifiedAttributes.push_back(mRightVector);
}

void EMT::Ph1::VoltageSourceNorton::mnaCompPreStep(Real time, Int timeStepCount) {
	updateState(time);
	mnaCompApplyRightSideVectorStamp(**mRightVector);
}

void EMT::Ph1::VoltageSourceNorton::mnaCompAddPostStepDependencies(AttributeBase::List &prevStepDependencies, AttributeBase::List &attributeDependencies, AttributeBase::List &modifiedAttributes, Attribute<Matrix>::Ptr &leftVector) {
	attributeDependencies.push_back(leftVector);
	modifiedAttributes.push_back(mIntfCurrent);
	modifiedAttributes.push_back(mIntfVoltage);
}

void EMT::Ph1::VoltageSourceNorton::mnaCompPostStep(Real time, Int timeStepCount, Attribute<Matrix>::Ptr &leftVector) {
	mnaCompUpdateVoltage(**leftVector);
	mnaCompUpdateCurrent(**leftVector);
}

void EMT::Ph1::VoltageSourceNorton::mnaCompUpdateVoltage(const Matrix& leftVector) {
	// Calculate v1 - v0
	if (terminalNotGrounded(1))
...
void EMT::Ph1::VoltageSourceNorton::mnaCompUpdateCurrent(const Matrix& leftVector) {
	// TODO: verify signs
