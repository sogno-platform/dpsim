...
EMT::Ph3::ControlledVoltageSource::ControlledVoltageSource(
    String uid, String name, Logger::Level logLevel)
    : MNASimPowerComp<Real>(uid, name, true, true, logLevel),
      mVoltageRef(mAttributes->createDynamic<Matrix>(
...
void EMT::Ph3::ControlledVoltageSource::initializeFromNodesAndTerminals(
    Real frequency) {
...
void EMT::Ph3::ControlledVoltageSource::mnaCompInitialize(
    Real omega, Real timeStep, Attribute<Matrix>::Ptr leftVector) {
  updateMatrixNodeIndices();
}

void EMT::Ph3::ControlledVoltageSource::mnaCompApplySystemMatrixStamp(
...
void EMT::Ph3::ControlledVoltageSource::mnaCompApplyRightSideVectorStamp(
    Matrix &rightVector) {
...
void EMT::Ph3::ControlledVoltageSource::mnaCompAddPreStepDependencies(
...
void EMT::Ph3::ControlledVoltageSource::mnaCompAddPostStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes,
...
void EMT::Ph3::ControlledVoltageSource::mnaCompPostStep(
    Real time, Int timeStepCount, Attribute<Matrix>::Ptr &leftVector) {
  mnaCompUpdateCurrent(**leftVector);
}

void EMT::Ph3::ControlledVoltageSource::mnaCompUpdateCurrent(
