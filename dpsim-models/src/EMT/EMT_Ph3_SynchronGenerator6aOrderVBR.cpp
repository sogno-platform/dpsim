...
void EMT::Ph3::SynchronGenerator6aOrderVBR::specificInitialization() {
  ...
  (**mEdq0_t)(1, 0) =
      (1 - mTaa / mTd0_t) * **mEf - (mLd - mLd_t - mYd) * (**mIdq0)(0, 0);
  ...
  mEh_t(1, 0) = mAq_t * (**mIdq0)(0, 0) + mBq_t * (**mEdq0_t)(1, 0) +
                mDq_t * (**mEf) + mDq_t * mEf_prev;
  mEh_t(2, 0) = 0.0;
  ...
  SPDLOG_LOGGER_INFO(mSLog,
                     ...
                     (**mEdq0_t)(0, 0), (**mEdq0_t)(1, 0), (**mEdq0_s)(0, 0),
                     (**mEdq0_s)(1, 0));
  mSLog->flush();
}
...
void EMT::Ph3::SynchronGenerator6aOrderVBR::stepInPerUnit() {
  ...
  mEh_s(0, 0) = mAd_s * (**mIdq0)(1, 0) + mBd_s * (**mEdq0_t)(0, 0) +
                mCd_s * (**mEdq0_s)(0, 0);
  mEh_s(1, 0) = mAq_s * (**mIdq0)(0, 0) + mBq_s * (**mEdq0_t)(1, 0) +
                mCq_s * (**mEdq0_s)(1, 0) + mDq_s * (**mEf) + mDq_s * mEf_prev;
  mEh_s(2, 0) = 0.0;
