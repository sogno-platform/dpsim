...
EMT::Ph3::SynchronGeneratorDQ::SynchronGeneratorDQ(String uid, String name,
...
EMT::Ph3::SynchronGeneratorDQ::SynchronGeneratorDQ(String name,
                                                   Logger::Level logLevel)
    : SynchronGeneratorDQ(name, name, logLevel) {}

EMT::Ph3::SynchronGeneratorDQ::~SynchronGeneratorDQ() {}

Real EMT::Ph3::SynchronGeneratorDQ::electricalTorque() const {
  return **mElecTorque * mBase_T;
}

Real EMT::Ph3::SynchronGeneratorDQ::rotationalSpeed() const {
...
void EMT::Ph3::SynchronGeneratorDQ::setParametersFundamentalPerUnit(
  ...
  SPDLOG_LOGGER_INFO(
      ...
      "initVoltAngle: {:e} [deg] \n"
      "initMechPower: {:e} [W]",
      mInitElecPower.real(), mInitElecPower.imag(), mInitTerminalVoltage,
      mInitTerminalVoltage / mBase_V, CPS::Math::radtoDeg(mInitVoltAngle),
      mInitMechPower);
}
...
void EMT::Ph3::SynchronGeneratorDQ::setInitialValues(Real initActivePower,
...
void EMT::Ph3::SynchronGeneratorDQ::applyParametersOperationalPerUnit() {
  ...
  SPDLOG_LOGGER_INFO(mSLog,
                     "Apply operational parameters in per unit: \n"
                     "poleNumber: {:d}\ninertia: {:e}\n"
                     "Rs: {:e}\nLd: {:e}\nLq: {:e}\nLl: {:e}\n"
                     "Ld_t: {:e}\nLq_t: {:e}\nLd_s: {:e}\nLq_s: {:e}\n"
                     "Td0_t: {:e}\nTq0_t: {:e}\nTd0_s: {:e}\nTq0_s: {:e}\n",
                     mPoleNumber, **mInertia, **mRs, **mLd, **mLq, **mLl,
                     **mLd_t, **mLq_t, **mLd_s, **mLq_s, **mTd0_t, **mTq0_t,
                     **mTd0_s, **mTq0_s);

  Base::SynchronGenerator::calculateFundamentalFromOperationalParameters();
  SPDLOG_LOGGER_INFO(
      mSLog,
      "Updated fundamental parameters in per unit: \n"
      "Rs: {:e}\nLl: {:e}\nLmd: {:e}\nLmq: {:e}\nRfd: {:e}\nLlfd: {:e}\nRkd: "
      "{:e}\n"
      "Llkd: {:e}\nRkq1: {:e}\nLlkq1: {:e}\nRkq2: {:e}\nLlkq2: {:e}\n",
      **mRs, **mLl, mLmd, mLmq, mRfd, mLlfd, mRkd, mLlkd, mRkq1, mLlkq1, mRkq2,
...
void EMT::Ph3::SynchronGeneratorDQ::initializeFromNodesAndTerminals(
    Real frequency) {
...
void EMT::Ph3::SynchronGeneratorDQ::mnaCompApplySystemMatrixStamp(
...
void EMT::Ph3::SynchronGeneratorDQ::mnaCompApplyRightSideVectorStamp(
    Matrix &rightVector) {
  if (mCompensationOn)
...
void EMT::Ph3::SynchronGeneratorDQ::mnaCompUpdateVoltage(
...
void EMT::Ph3::SynchronGeneratorDQ::mnaCompAddPostStepDependencies(
...
void EMT::Ph3::SynchronGeneratorDQ::mnaCompPostStep(
    Real time, Int timeStepCount, Attribute<Matrix>::Ptr &leftVector) {
  mnaCompUpdateVoltage(**leftVector);
}

Matrix EMT::Ph3::SynchronGeneratorDQ::abcToDq0Transform(Real theta,
                                                        Matrix &abcVector) {
...
Matrix EMT::Ph3::SynchronGeneratorDQ::dq0ToAbcTransform(Real theta,
                                                        Matrix &dq0Vector) {
