...
EMT::Ph3::VSIVoltageControlDQ::VSIVoltageControlDQ(String uid, String name,
  ...
  **mIntfCurrent = Matrix::Zero(3, 1);
  ...
  mVoltageControllerVSI = Signal::VoltageControllerVSI::make(
      **mName + "_VoltageControllerVSI", mLogLevel);
...
void EMT::Ph3::VSIVoltageControlDQ::setParameters(Real Omega, Real VdRef,
                                                  Real VqRef, Real Pref) {
  mParametersSet = true;
...
void EMT::Ph3::VSIVoltageControlDQ::setTransformerParameters(
...
void EMT::Ph3::VSIVoltageControlDQ::setControllerParameters(
    Real Kp_voltageCtrl, Real Ki_voltageCtrl, Real Kp_currCtrl,
    Real Ki_currCtrl, Real Omega, Real m_p, Real tau_p, Real tau_l) {

  SPDLOG_LOGGER_INFO(mSLog, "Control Parameters:");
  SPDLOG_LOGGER_INFO(mSLog, "Voltage Loop: K_p = {}, K_i = {}", Kp_voltageCtrl,
                     Ki_voltageCtrl);
  SPDLOG_LOGGER_INFO(mSLog, "Current Loop: K_p = {}, K_i = {}", Kp_currCtrl,
                     Ki_currCtrl);
  SPDLOG_LOGGER_INFO(mSLog, "VCO: Omega_Nom = {}", Omega);
  SPDLOG_LOGGER_INFO(mSLog, "Droop Control: M_p = {}, Tau_p = {}, Tau_l  = {}",
                     m_p, tau_p, tau_l);

  mDroop->setControllerParameters(m_p, tau_p, tau_l);
  mVoltageControllerVSI->setControllerParameters(
      Kp_voltageCtrl, Ki_voltageCtrl, Kp_currCtrl, Ki_currCtrl, Omega);
}

// setter for internal filter parameters
void EMT::Ph3::VSIVoltageControlDQ::setFilterParameters(Real Lf, Real Cf,
                                                        Real Rf, Real Rc) {
...
void EMT::Ph3::VSIVoltageControlDQ::setInitialStateValues(Real phi_dInit,
                                                          Real phi_qInit,
                                                          Real gamma_dInit,
                                                          Real gamma_qInit) {
  ...
  mVoltageControllerVSI->setInitialStateValues(phi_dInit, phi_qInit,
                                               gamma_dInit, gamma_qInit);
}

void EMT::Ph3::VSIVoltageControlDQ::initializeFromNodesAndTerminals(
    Real frequency) {
  ...
  intfCurrentComplex(0, 0) = -std::conj(
      2. / 3. * Complex(activePower, reactivePower) / intfVoltageComplex(0, 0));
  ...
  **mElecPassivePower = (3. / 2. * intfVoltageComplex(0, 0) *
  ...
  if (mWithConnectionTransformer) {
    ...
    **mElecActivePower = **mIrcd * **mVcd + **mIrcq * **mVcq;
    ...
    mDroop->setInitialStateValues(matrixInputInit, matrixStateInit,
                                  matrixOutputInit);
...
void EMT::Ph3::VSIVoltageControlDQ::addControlPreStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes) {
  // add pre-step dependencies of subcomponents
  mDroop->signalAddPreStepDependencies(
      prevStepDependencies, attributeDependencies, modifiedAttributes);
  mVCO->signalAddPreStepDependencies(prevStepDependencies,
                                     attributeDependencies, modifiedAttributes);
  mVoltageControllerVSI->signalAddPreStepDependencies(
      prevStepDependencies, attributeDependencies, modifiedAttributes);
}

void EMT::Ph3::VSIVoltageControlDQ::controlPreStep(Real time,
                                                   Int timeStepCount) {
...
void EMT::Ph3::VSIVoltageControlDQ::addControlStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes) {
  // add step dependencies of subcomponents
  mDroop->signalAddStepDependencies(prevStepDependencies, attributeDependencies,
                                    modifiedAttributes);
  mVCO->signalAddStepDependencies(prevStepDependencies, attributeDependencies,
                                  modifiedAttributes);
...
Matrix
EMT::Ph3::VSIVoltageControlDQ::parkTransformPowerInvariant(Real theta,
                                                           const Matrix &fabc) {
...
Matrix EMT::Ph3::VSIVoltageControlDQ::getParkTransformMatrixPowerInvariant(
    Real theta) {
...
Matrix EMT::Ph3::VSIVoltageControlDQ::inverseParkTransformPowerInvariant(
...
Matrix
EMT::Ph3::VSIVoltageControlDQ::getInverseParkTransformMatrixPowerInvariant(
    Real theta) {
...
void EMT::Ph3::VSIVoltageControlDQ::controlStep(Real time, Int timeStepCount) {
  ...
  **mVsref = inverseParkTransformPowerInvariant(
      (**mVCO->mOutputPrev)(0, 0), mVoltageControllerVSI->mOutputCurr->get());

  mThetaN = mThetaN + mTimeStep * **mOmegaN;
}

void EMT::Ph3::VSIVoltageControlDQ::mnaParentAddPreStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes) {
...
void EMT::Ph3::VSIVoltageControlDQ::mnaParentAddPostStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes,
...
void EMT::Ph3::VSIVoltageControlDQ::mnaParentPostStep(
...
//Current update
void EMT::Ph3::VSIVoltageControlDQ::mnaCompUpdateCurrent(
