...
EMT::Ph3::VSIVoltageControlVCO::VSIVoltageControlVCO(String uid, String name,
...
void EMT::Ph3::VSIVoltageControlVCO::setParameters(Real sysOmega, Real VdRef,
                                                   Real VqRef) {
  mParametersSet = true;
...
void EMT::Ph3::VSIVoltageControlVCO::setTransformerParameters(
...
void EMT::Ph3::VSIVoltageControlVCO::setControllerParameters(
    Real Kp_voltageCtrl, Real Ki_voltageCtrl, Real Kp_currCtrl,
    Real Ki_currCtrl, Real Omega_nominal) {
...
void EMT::Ph3::VSIVoltageControlVCO::setFilterParameters(Real Lf, Real Cf,
                                                         Real Rf, Real Rc) {
...
void EMT::Ph3::VSIVoltageControlVCO::setInitialStateValues(Real phi_dInit,
                                                           Real phi_qInit,
                                                           Real gamma_dInit,
                                                           Real gamma_qInit) {
...
void EMT::Ph3::VSIVoltageControlVCO::initializeParentFromNodesAndTerminals(
    Real frequency) {
...
void EMT::Ph3::VSIVoltageControlVCO::mnaParentInitialize(
...
void EMT::Ph3::VSIVoltageControlVCO::addControlPreStepDependencies(
...
void EMT::Ph3::VSIVoltageControlVCO::controlPreStep(Real time,
                                                    Int timeStepCount) {
...
void EMT::Ph3::VSIVoltageControlVCO::addControlStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes) {
...
void EMT::Ph3::VSIVoltageControlVCO::mnaParentAddPreStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes) {
...
void EMT::Ph3::VSIVoltageControlVCO::mnaParentPreStep(Real time,
                                                      Int timeStepCount) {
...
void EMT::Ph3::VSIVoltageControlVCO::mnaParentAddPostStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes,
...
void EMT::Ph3::VSIVoltageControlVCO::mnaParentPostStep(
...
//Current update
void EMT::Ph3::VSIVoltageControlVCO::mnaCompUpdateCurrent(
...
//Voltage update
void EMT::Ph3::VSIVoltageControlVCO::mnaCompUpdateVoltage(
    const Matrix &leftVector) {
