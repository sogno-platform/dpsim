...
void EMT::Ph3::VoltageSourceNorton::setVoltageRef(Complex voltage) const { **mVoltageRef = voltage; }
...
void EMT::Ph3::VoltageSourceNorton::mnaCompInitialize(Real omega, Real timeStep, Attribute<Matrix>::Ptr leftVector) {
...
void EMT::Ph3::VoltageSourceNorton::mnaCompApplySystemMatrixStamp(SparseMatrixRow& systemMatrix) {
...
void EMT::Ph3::VoltageSourceNorton::mnaCompApplyRightSideVectorStamp(Matrix& rightVector) {
...
void EMT::Ph3::VoltageSourceNorton::mnaCompUpdateVoltage(const Matrix& leftVector) {
	// Calculate v1 - v0
	if (terminalNotGrounded(1)) {
...
void EMT::Ph3::VoltageSourceNorton::mnaCompAddPreStepDependencies(AttributeBase::List &prevStepDependencies, AttributeBase::List &attributeDependencies, AttributeBase::List &modifiedAttributes) {
	attributeDependencies.push_back(mVoltageRef);
	modifiedAttributes.push_back(mRightVector);
	modifiedAttributes.push_back(mIntfVoltage);
}

void EMT::Ph3::VoltageSourceNorton::mnaCompPreStep(Real time, Int timeStepCount) {
	updateState(time);
	mnaCompApplyRightSideVectorStamp(**mRightVector);
}

void EMT::Ph3::VoltageSourceNorton::mnaCompAddPostStepDependencies(AttributeBase::List &prevStepDependencies, AttributeBase::List &attributeDependencies, AttributeBase::List &modifiedAttributes, Attribute<Matrix>::Ptr &leftVector) {
	attributeDependencies.push_back(leftVector);
	modifiedAttributes.push_back(mIntfCurrent);
}

void EMT::Ph3::VoltageSourceNorton::mnaCompPostStep(Real time, Int timeStepCount, Attribute<Matrix>::Ptr &leftVector) {
	mnaCompUpdateVoltage(**leftVector);
	mnaCompUpdateCurrent(**leftVector);
}

void EMT::Ph3::VoltageSourceNorton::mnaCompUpdateCurrent(const Matrix& leftVector) {
