...
SP::Ph1::AvVoltageSourceInverterDQ::AvVoltageSourceInverterDQ(
  ...
  **mIntfCurrent = MatrixComp::Zero(1, 1);
  ...
  mSubCtrledVoltageSource =
      SP::Ph1::VoltageSource::make(**mName + "_src", mLogLevel);
...
void SP::Ph1::AvVoltageSourceInverterDQ::setParameters(Real sysOmega,
                                                       Real sysVoltNom,
                                                       Real Pref, Real Qref) {
  mParametersSet = true;
...
void SP::Ph1::AvVoltageSourceInverterDQ::setFilterParameters(Real Lf, Real Cf,
                                                             Real Rf, Real Rc) {
...
void SP::Ph1::AvVoltageSourceInverterDQ::setInitialStateValues(
...
void SP::Ph1::AvVoltageSourceInverterDQ::initializeFromNodesAndTerminals(
  ...
  ircdq = Math::rotatingFrame2to1(
      -1. * mSubResistorC->mIntfCurrent->get()(0, 0),
      std::arg(mVirtualNodes[3]->initialSingleVoltage()), 0);
  **mVcd = vcdq.real();
  **mVcq = vcdq.imag();
  **mIrcd = ircdq.real();
...
void SP::Ph1::AvVoltageSourceInverterDQ::addControlPreStepDependencies(
...
void SP::Ph1::AvVoltageSourceInverterDQ::controlPreStep(Real time,
                                                        Int timeStepCount) {
...
void SP::Ph1::AvVoltageSourceInverterDQ::addControlStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes) const {
...
void SP::Ph1::AvVoltageSourceInverterDQ::controlStep(Real time,
                                                     Int timeStepCount) {
  ...
  ircdq = Math::rotatingFrame2to1(
      -1. * mSubResistorC->attributeTyped<MatrixComp>("i_intf")->get()(0, 0),
      mPLL->attributeTyped<Matrix>("output_prev")->get()(0, 0), mThetaN);
  **mVcd = vcdq.real();
  **mVcq = vcdq.imag();
  **mIrcd = ircdq.real();
...
void SP::Ph1::AvVoltageSourceInverterDQ::mnaParentAddPreStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
...
void SP::Ph1::AvVoltageSourceInverterDQ::mnaParentPreStep(Real time,
                                                          Int timeStepCount) {
...
void SP::Ph1::AvVoltageSourceInverterDQ::mnaParentAddPostStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes,
...
void SP::Ph1::AvVoltageSourceInverterDQ::mnaParentPostStep(
    Real time, Int timeStepCount, Attribute<Matrix>::Ptr &leftVector) {
  mnaCompUpdateCurrent(**leftVector);
  mnaCompUpdateVoltage(**leftVector);
}

void SP::Ph1::AvVoltageSourceInverterDQ::mnaCompUpdateCurrent(
    const Matrix &leftvector) {
  if (mWithConnectionTransformer)
    **mIntfCurrent =
        mConnectionTransformer->attributeTyped<MatrixComp>("i_intf")->get();
  else
    **mIntfCurrent = mSubResistorC->attributeTyped<MatrixComp>("i_intf")->get();
}

void SP::Ph1::AvVoltageSourceInverterDQ::mnaCompUpdateVoltage(
    const Matrix &leftVector) {
