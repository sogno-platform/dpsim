...
void SP::Ph1::ControlledVoltageSource::setParameters(Complex voltageRef) {
...
void SP::Ph1::ControlledVoltageSource::mnaCompAddPreStepDependencies(
...
void SP::Ph1::ControlledVoltageSource::mnaCompAddPostStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes,
...
void SP::Ph1::ControlledVoltageSource::mnaCompInitialize(
...
void SP::Ph1::ControlledVoltageSource::mnaCompApplySystemMatrixStamp(
...
void SP::Ph1::ControlledVoltageSource::mnaCompApplyRightSideVectorStamp(
    Matrix &rightVector) {
...
void SP::Ph1::ControlledVoltageSource::updateVoltage(Real time) {
  (**mIntfVoltage)(0, 0) = **mVoltageRef;
...
void SP::Ph1::ControlledVoltageSource::mnaCompPostStep(
