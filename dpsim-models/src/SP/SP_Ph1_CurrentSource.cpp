...
SP::Ph1::CurrentSource::CurrentSource(String uid, String name,
...
SP::Ph1::CurrentSource::CurrentSource(String name, Complex current,
                                      Logger::Level logLevel)
...
void SP::Ph1::CurrentSource::mnaCompInitialize(
    Real omega, Real timeStep, Attribute<Matrix>::Ptr leftVector) {
  updateMatrixNodeIndices();
  (**mIntfCurrent)(0, 0) = **mCurrentRef;
}

void SP::Ph1::CurrentSource::mnaCompAddPreStepDependencies(
...
void SP::Ph1::CurrentSource::mnaCompApplyRightSideVectorStamp(
    Matrix &rightVector) {
  (**mIntfCurrent)(0, 0) = **mCurrentRef;
...
void SP::Ph1::CurrentSource::mnaCompAddPostStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes,
...
void SP::Ph1::CurrentSource::mnaCompPostStep(
