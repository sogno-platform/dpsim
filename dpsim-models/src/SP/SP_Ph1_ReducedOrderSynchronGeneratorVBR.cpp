...
void SP::Ph1::ReducedOrderSynchronGeneratorVBR::initializeResistanceMatrix() {
  ...
  mResistanceMatrixDq << 0.0, mA, mB, 0.0;
...
void SP::Ph1::ReducedOrderSynchronGeneratorVBR::mnaCompInitialize(
...
void SP::Ph1::ReducedOrderSynchronGeneratorVBR::mnaCompApplySystemMatrixStamp(
...
void SP::Ph1::ReducedOrderSynchronGeneratorVBR::
...
void SP::Ph1::ReducedOrderSynchronGeneratorVBR::mnaCompPostStep(
...
Matrix
SP::Ph1::ReducedOrderSynchronGeneratorVBR::get_DqToComplexATransformMatrix()
    const {
  Matrix dqToComplexA(2, 2);
  dqToComplexA << cos(**mThetaMech - mBase_OmMech * mSimTime),
      -sin(**mThetaMech - mBase_OmMech * mSimTime),
      sin(**mThetaMech - mBase_OmMech * mSimTime),
      cos(**mThetaMech - mBase_OmMech * mSimTime);
