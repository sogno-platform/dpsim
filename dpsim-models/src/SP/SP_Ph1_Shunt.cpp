...
void SP::Ph1::Shunt::initializeFromNodesAndTerminals(Real frequency) {
  ...
  if (**mSusceptance > 0) {
    mSubCapacitor =
        std::make_shared<SP::Ph1::Capacitor>(**mName + "_cap", mLogLevel);
...
void SP::Ph1::Shunt::mnaParentAddPostStepDependencies(
...
void SP::Ph1::Shunt::mnaParentPostStep(Real time, Int timeStepCount,
                                       Attribute<Matrix>::Ptr &leftVector) {
