...
SP::Ph1::SynchronGeneratorTrStab::clone(String name) {
...
void SP::Ph1::SynchronGeneratorTrStab::setFundamentalParametersPU(
...
void SP::Ph1::SynchronGeneratorTrStab::setStandardParametersSI(
...
void SP::Ph1::SynchronGeneratorTrStab::setStandardParametersPU(
...
void SP::Ph1::SynchronGeneratorTrStab::setModelFlags(
...
void SP::Ph1::SynchronGeneratorTrStab::setInitialValues(Complex elecPower,
                                                        Real mechPower) {
...
void SP::Ph1::SynchronGeneratorTrStab::initializeFromNodesAndTerminals(
  ...
  **mElecReactivePower =
      ((**mIntfVoltage)(0, 0) * std::conj(-(**mIntfCurrent)(0, 0))).imag();
  ...
  **mMechPower = **mElecActivePower;
  ...
  SPDLOG_LOGGER_INFO(mSLog,
                     ...
                     mInitElecPower.imag(), **mElecActivePower,
                     **mElecReactivePower, **mMechPower);
}
...
void SP::Ph1::SynchronGeneratorTrStab::mnaParentInitialize(
...
void SP::Ph1::SynchronGeneratorTrStab::mnaParentAddPreStepDependencies(
...
void SP::Ph1::SynchronGeneratorTrStab::mnaParentAddPostStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes,
...
void SP::Ph1::SynchronGeneratorTrStab::mnaParentPreStep(Real time,
                                                        Int timeStepCount) {
  step(time);
...
void SP::Ph1::SynchronGeneratorTrStab::AddBStep::execute(Real time,
                                                         Int timeStepCount) {
  **mGenerator.mRightVector = mGenerator.mSubInductor->mRightVector->get() +
                              mGenerator.mSubVoltageSource->mRightVector->get();
}

void SP::Ph1::SynchronGeneratorTrStab::mnaParentPostStep(
    Real time, Int timeStepCount, Attribute<Matrix>::Ptr &leftVector) {
  mnaCompUpdateVoltage(**leftVector);
  mnaCompUpdateCurrent(**leftVector);
}

void SP::Ph1::SynchronGeneratorTrStab::mnaCompUpdateVoltage(
...
void SP::Ph1::SynchronGeneratorTrStab::mnaCompUpdateCurrent(
    const Matrix &leftVector) {
...
void SP::Ph1::SynchronGeneratorTrStab::setReferenceOmega(
