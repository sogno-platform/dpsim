...
SP::Ph3::VoltageSource::VoltageSource(String uid, String name,
...
void SP::Ph3::VoltageSource::mnaCompApplySystemMatrixStamp(
...
void SP::Ph3::VoltageSource::mnaCompAddPreStepDependencies(
...
void SP::Ph3::VoltageSource::mnaCompAddPostStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes,
...
void SP::Ph3::VoltageSource::mnaCompPostStep(
