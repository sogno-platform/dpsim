...
void ExciterDC1Simp::setParameters(
  ...
  if (auto temp_struct =
          std::dynamic_pointer_cast<Signal::ExciterDC1SimpParameters>(
              parameters)) {
    mTa = temp_struct->Ta;
    ...
    std::cout << "The type of the ExciterParameters of " << this->name()
              << " has to be ExciterDC1SimpParameters!" << std::endl;
