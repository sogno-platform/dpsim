...
void VoltageControllerVSI::setParameters(Real VdRef, Real VqRef) {
  ...
  SPDLOG_LOGGER_INFO(mSLog,
                     "Voltage D Amplitude={} [V] Voltage Q Amplitude={} [V]",
                     mVdRef, mVqRef);
}
...
void VoltageControllerVSI::setControllerParameters(Real Kp_voltageCtrl,
  ...
  SPDLOG_LOGGER_INFO(mSLog, "Voltage Loop: K_i = {}, K_p = {}", Ki_voltageCtrl,
                     Kp_voltageCtrl);
  SPDLOG_LOGGER_INFO(mSLog, "Current Loop: K_i = {}, K_p = {}", Ki_currCtrl,
                     Kp_currCtrl);
...
void VoltageControllerVSI::setInitialStateValues(Real phi_dInit, Real phi_qInit,
                                                 Real gamma_dInit,
                                                 Real gamma_qInit) {
...
void VoltageControllerVSI::initializeStateSpaceModel(
...
void VoltageControllerVSI::signalAddPreStepDependencies(
...
void VoltageControllerVSI::signalAddStepDependencies(
    AttributeBase::List &prevStepDependencies,
    AttributeBase::List &attributeDependencies,
    AttributeBase::List &modifiedAttributes) {
