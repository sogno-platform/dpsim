...
int main(int argc, char **argv) {
  ...
  SystemTopology systemEMT = reader2.loadCIM(
      scenario.systemFrequency, filenames, CPS::Domain::EMT, PhaseType::ABC);
  Examples::Grids::CIGREMV::addInvertersToCIGREMV(systemEMT, scenario,
                                                  Domain::EMT);
  ...
  std::shared_ptr<SwitchEvent3Ph> loadStepEvent =
      Examples::Events::createEventAddPowerConsumption3Ph(
          "N11", 2 - timeStep, 1500.0e3, systemEMT, Domain::EMT, logger);
