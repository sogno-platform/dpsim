...
int main(int argc, char *argv[]) {
  ...
  SystemTopology sys =
      reader.loadCIM(60, filenames, Domain::SP, PhaseType::Single,
  ...
  logger->logAttribute(
      "delta_r_1",
      sys.component<Ph1::SynchronGeneratorTrStab>("GEN1")->attribute(
          "delta_r"));
  logger->logAttribute(
      "delta_r_2",
      sys.component<Ph1::SynchronGeneratorTrStab>("GEN2")->attribute(
          "delta_r"));
  logger->logAttribute(
      "delta_r_3",
      sys.component<Ph1::SynchronGeneratorTrStab>("GEN3")->attribute(
          "delta_r"));
  logger->logAttribute(
      "P_elec_1",
      sys.component<Ph1::SynchronGeneratorTrStab>("GEN1")->attribute("P_elec"));
  logger->logAttribute(
      "P_elec_2",
      sys.component<Ph1::SynchronGeneratorTrStab>("GEN2")->attribute("P_elec"));
  logger->logAttribute(
      "P_elec_3",
      sys.component<Ph1::SynchronGeneratorTrStab>("GEN3")->attribute("P_elec"));
  logger->logAttribute(
      "P_elec_1",
      sys.component<Ph1::SynchronGeneratorTrStab>("GEN1")->attribute("P_elec"));
  logger->logAttribute(
