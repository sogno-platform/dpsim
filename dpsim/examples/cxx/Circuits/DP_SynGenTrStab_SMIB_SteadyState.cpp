...
void DP_1ph_SynGenTrStab_SteadyState(String simName, Real timeStep,
  ...
  auto systemDP = SystemTopology(60, SystemNodeList{n1DP, n2DP},
...
int main(int argc, char *argv[]) {
  ...
  DP_1ph_SynGenTrStab_SteadyState(simName, timeStep, finalTime, cmdInertia,
                                  cmdDamping);
}
