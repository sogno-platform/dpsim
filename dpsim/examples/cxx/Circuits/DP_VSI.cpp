...
void DP_Ph1_VSI2_4bus_SampleGrid() {
  ...
  auto vsi2 =
      Ph1::AvVoltageSourceInverterDQ::make("vsi2", Logger::Level::debug);
  ...
  auto sys = SystemTopology(50, SystemNodeList{n1, n2, n3, n4, n5, n6, n7},
                            SystemComponentList{vsi, vs, piline, rline2, rline3,
                                                rline4, rload, rload2, Lload,
                                                Lload2, vsi2});
...
int main(int argc, char *argv[]) { DP_Ph1_VSI2_4bus_SampleGrid(); }
