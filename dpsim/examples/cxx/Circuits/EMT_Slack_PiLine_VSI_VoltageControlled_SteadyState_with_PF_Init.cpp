...
int main(int argc, char *argv[]) {
  ...
  loadPF->setParameters(loadActivePower, loadReactivePower,
  ...
  loadEMT->setParameters(
      CPS::Math::singlePhasePowerToThreePhase(loadActivePower),
      CPS::Math::singlePhasePowerToThreePhase(loadReactivePower),
      scenario.systemNominalVoltage);
  ...
  pv->setControllerParameters(scenario.KpVoltageCtrl, scenario.KiVoltageCtrl,
                              ...
                              scenario.systemNominalOmega, scenario.m_p,
                              scenario.tau_p, scenario.tau_l);
  ...
  auto systemEMT =
      SystemTopology(scenario.systemNominalFreq, SystemNodeList{n1EMT, n2EMT},
