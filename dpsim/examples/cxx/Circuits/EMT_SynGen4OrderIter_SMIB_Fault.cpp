...
void EMT_3ph_4OrderSynGenIter(String simName, Real timeStep, Real finalTime,
                              Real H, Real startTimeFault, Real endTimeFault,
                              Real switchClosed, Real logDownSampling,
  ...
  genPF->setParameters(nomPower, VnomMV, setPointActivePower, setPointVoltage,
                       PowerflowBusType::PV);
...
int main(int argc, char *argv[]) {
  ...
  std::string simName = "EMT_SynGen4OrderIter_SMIB_Fault" + stepSize_str +
                        tolerance_str + iteration_str;
  ...
  EMT_3ph_4OrderSynGenIter(simName, timeStep, finalTime, H, startTimeFault,
                           endTimeFault, switchClosed, logDownSampling,
