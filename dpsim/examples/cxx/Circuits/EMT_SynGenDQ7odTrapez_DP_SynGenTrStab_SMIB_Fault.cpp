...
void EMT_3ph_SynGenDQ7odTrapez_ThreePhFault(Real timeStep, Real finalTime,
                                            bool startFaultEvent,
                                            bool endFaultEvent,
                                            Real startTimeFault,
                                            Real endTimeFault) {
  ...
  genPF->setParameters(syngenKundur.nomPower, syngenKundur.nomVoltage,
                       setPointActivePower, setPointVoltage,
                       PowerflowBusType::PV);
  ...
  auto systemPF = SystemTopology(nomFreq, SystemNodeList{n1PF, n2PF},
  ...
  gen->setParametersFundamentalPerUnit(
      ...
      syngenKundur.Ll, syngenKundur.Lmd, syngenKundur.Lmq, syngenKundur.Rfd,
      syngenKundur.Llfd, syngenKundur.Rkd, syngenKundur.Llkd, syngenKundur.Rkq1,
      syngenKundur.Llkq1, syngenKundur.Rkq2, syngenKundur.Llkq2, syngenKundur.H,
  ...
  auto system = SystemTopology(nomFreq, SystemNodeList{n1, n2},
...
void DP_1ph_SynGenTrStab_Fault(Real timeStep, Real finalTime,
  ...
  // Components
  auto gen = CPS::DP::Ph1::SynchronGeneratorTrStab::make("SynGen",
                                                         Logger::Level::debug);
  gen->setFundamentalParametersPU(syngenKundur.nomPower,
                                  syngenKundur.nomVoltage, syngenKundur.nomFreq,
                                  syngenKundur.Ll, syngenKundur.Lmd,
                                  syngenKundur.Llfd, syngenKundur.H, 1.5);
  ...
  line->setParameters(lineResistance, lineInductance, lineCapacitance,
                      lineConductance);
  ...
  //Switch
  auto fault =
      CPS::DP::Ph1::varResSwitch::make("Br_fault", Logger::Level::debug);
  fault->setParameters(BreakerOpen, BreakerClosed);
  ...
  auto system = SystemTopology(60, SystemNodeList{n1, n2},
                               SystemComponentList{gen, line, fault, extnet});
...
void SP_1ph_SynGenTrStab_Fault(Real timeStep, Real finalTime,
                               bool startFaultEvent, bool endFaultEvent,
                               Real startTimeFault, Real endTimeFault) {
  //  // ----- POWERFLOW FOR INITIALIZATION -----
  Real timeStepPF = finalTime;
  ...
  // Components
  auto gen = CPS::SP::Ph1::SynchronGeneratorTrStab::make("SynGen",
                                                         Logger::Level::debug);
  gen->setFundamentalParametersPU(syngenKundur.nomPower,
                                  syngenKundur.nomVoltage, syngenKundur.nomFreq,
                                  syngenKundur.Ll, syngenKundur.Lmd,
  ...
  //Switch
  auto fault =
      CPS::SP::Ph1::varResSwitch::make("Br_fault", Logger::Level::debug);
  fault->setParameters(BreakerOpen, BreakerClosed);
  fault->setInitParameters(timeStep);
  fault->open();
...
int main(int argc, char *argv[]) {
  ...
  EMT_3ph_SynGenDQ7odTrapez_ThreePhFault(timeStep, finalTime, startFaultEvent,
                                         endFaultEvent, startTimeFault,
                                         endTimeFault);

  //Transient Stability model(classical model 2nd order)
  DP_1ph_SynGenTrStab_Fault(timeStep, finalTime, startFaultEvent, endFaultEvent,
                            startTimeFault, endTimeFault);
  SP_1ph_SynGenTrStab_Fault(timeStep, finalTime, startFaultEvent, endFaultEvent,
                            startTimeFault, endTimeFault);
}
