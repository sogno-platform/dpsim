...
int main(int argc, char *argv[]) {
  ...
  Real lineResistance = lineCIGREHV.lineResistancePerKm * lineLength *
                        std::pow(ratio, 2); // HV parameters referred to MV side
  ...
  gen->setParametersOperationalPerUnit(
      ...
      syngenKundur.poleNum, syngenKundur.nomFieldCurr, Rs, Ld, Lq, Ld_t, Lq_t,
      Ld_s, Lq_s, Ll, Td0_t, Tq0_t, Td0_s, Tq0_s, H);
