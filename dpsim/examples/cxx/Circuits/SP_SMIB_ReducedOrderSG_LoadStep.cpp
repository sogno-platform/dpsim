...
int main(int argc, char *argv[]) {
  ...
  auto systemSP = SystemTopology(gridParams.nomFreq, SystemNodeList{n1SP, n2SP},
  ...
  std::shared_ptr<SwitchEvent> loadStepEvent =
      Examples::Events::createEventAddPowerConsumption(
          "n1SP", std::round(loadStepEventTime / timeStep) * timeStep,
          gridParams.loadStepActivePower, systemSP, Domain::SP, logger);
