...
int main(int argc, char *argv[]) {
  ...
  lineSP->setParameters(scenario.lineResistance, scenario.lineInductance,
                        scenario.lineCapacitance);

  auto pv = SP::Ph1::AvVoltageSourceInverterDQ::make(
      "pv", "pv", Logger::Level::debug, true);
  ...
  std::shared_ptr<SwitchEvent> loadStepEvent =
      CIM::Examples::Events::createEventAddPowerConsumption(
          "n2", std::round(5.0 / timeStep) * timeStep, 10e6, systemSP,
          Domain::SP, loggerSP);
