...
void SP_SynGenTrStab_3Bus_Fault(String simName, Real timeStep, Real finalTime,
  ...
  gen2SP->setReferenceOmega(gen1SP->attributeTyped<Real>("w_r"),
                            gen1SP->attributeTyped<Real>("delta_r"));

  //Load
  auto loadSP = SP::Ph1::Load::make("Load", Logger::Level::debug);
  loadSP->setParameters(ThreeBus.activePower_L, ThreeBus.reactivePower_L,
                        ThreeBus.Vnom);

  //Line12
  auto line12SP = SP::Ph1::PiLine::make("PiLine12", Logger::Level::debug);
  line12SP->setParameters(ThreeBus.lineResistance12, ThreeBus.lineInductance12,
                          ThreeBus.lineCapacitance12,
                          ThreeBus.lineConductance12);
  //Line13
  auto line13SP = SP::Ph1::PiLine::make("PiLine13", Logger::Level::debug);
  line13SP->setParameters(ThreeBus.lineResistance13, ThreeBus.lineInductance13,
                          ThreeBus.lineCapacitance13,
                          ThreeBus.lineConductance13);
  //Line23
  auto line23SP = SP::Ph1::PiLine::make("PiLine23", Logger::Level::debug);
  line23SP->setParameters(ThreeBus.lineResistance23, ThreeBus.lineInductance23,
                          ThreeBus.lineCapacitance23,
                          ThreeBus.lineConductance23);
  ...
  auto systemSP =
      SystemTopology(60, SystemNodeList{n1SP, n2SP, n3SP},
                     SystemComponentList{gen1SP, gen2SP, loadSP, line12SP,
                                         line13SP, line23SP, faultSP});
...
int main(int argc, char *argv[]) {
  ...
  SP_SynGenTrStab_3Bus_Fault(simName, timeStep, finalTime, startFaultEvent,
