...
void SP_SynGenTrStab_KRK_TwoAreaTrafo_SteadyState(
  ...
  gen1PF->setParameters(KRK_TwoArea.nomPower_G1, KRK_TwoArea.nomPhPhVoltRMS_G1,
                        ...
                        KRK_TwoArea.setPointVoltage_G1, PowerflowBusType::PV);
  ...
  gen2PF->setParameters(KRK_TwoArea.nomPower_G2, KRK_TwoArea.nomPhPhVoltRMS_G2,
                        ...
                        KRK_TwoArea.setPointVoltage_G2, PowerflowBusType::PV);
  ...
  gen3PF->setParameters(KRK_TwoArea.nomPower_G3, KRK_TwoArea.nomPhPhVoltRMS_G3,
                        ...
                        KRK_TwoArea.setPointVoltage_G3, PowerflowBusType::VD);
  ...
  gen4PF->setParameters(KRK_TwoArea.nomPower_G4, KRK_TwoArea.nomPhPhVoltRMS_G4,
                        ...
                        KRK_TwoArea.setPointVoltage_G4, PowerflowBusType::PV);
  gen4PF->setBaseVoltage(KRK_TwoArea.nomPhPhVoltRMS_G4);

  auto trafo15PF =
      SP::Ph1::Transformer::make("Transformer15", Logger::Level::debug);
  auto trafo26PF =
      SP::Ph1::Transformer::make("Transformer26", Logger::Level::debug);
  auto trafo311PF =
      SP::Ph1::Transformer::make("Transformer311", Logger::Level::debug);
  auto trafo410PF =
      SP::Ph1::Transformer::make("Transformer410", Logger::Level::debug);
  ...
  trafo15PF->setParameters(voltageMVSide, voltageHVSide, trafoPower,
                           std::abs(ratio), std::arg(ratio), trafoResistance,
                           trafoInductance);
  trafo15PF->setBaseVoltage(KRK_TwoArea.Vnom);

  trafo26PF->setParameters(voltageMVSide, voltageHVSide, trafoPower,
                           std::abs(ratio), std::arg(ratio), trafoResistance,
                           trafoInductance);
  trafo26PF->setBaseVoltage(KRK_TwoArea.Vnom);

  trafo311PF->setParameters(voltageMVSide, voltageHVSide, trafoPower,
                            std::abs(ratio), std::arg(ratio), trafoResistance,
                            trafoInductance);
  trafo311PF->setBaseVoltage(KRK_TwoArea.Vnom);

  trafo410PF->setParameters(voltageMVSide, voltageHVSide, trafoPower,
                            std::abs(ratio), std::arg(ratio), trafoResistance,
                            trafoInductance);
  ...
  auto systemPF = SystemTopology(
      ...
      SystemNodeList{n1PF, n2PF, n3PF, n4PF, n5PF, n6PF, n7PF, n8PF, n9PF,
                     n10PF, n11PF},
      SystemComponentList{gen1PF, gen2PF, gen3PF, gen4PF, trafo15PF, trafo26PF,
                          trafo311PF, trafo410PF, load7PF, load9PF, line56PF,
                          line67PF, line78_1PF, line78_2PF, line89_1PF,
                          line89_2PF, line910PF, line1011PF});
  ...
  gen1SP->setStandardParametersPU(KRK_TwoArea.nomPower_G1,
                                  KRK_TwoArea.nomPhPhVoltRMS_G1,
                                  KRK_TwoArea.nomFreq_G1, KRK_TwoArea.Xpd,
                                  KRK_TwoArea.H_G1, KRK_TwoArea.Rs, 10.0);
  ...
  // Xpd is given in p.u of generator base at transfomer primary side and should be transformed to network side
  gen2SP->setStandardParametersPU(KRK_TwoArea.nomPower_G2,
                                  KRK_TwoArea.nomPhPhVoltRMS_G2,
                                  KRK_TwoArea.nomFreq_G2, KRK_TwoArea.Xpd,
                                  KRK_TwoArea.H_G2, KRK_TwoArea.Rs, 10.0);
  ...
  // Xpd is given in p.u of generator base at transfomer primary side and should be transformed to network side
  gen3SP->setStandardParametersPU(KRK_TwoArea.nomPower_G3,
                                  KRK_TwoArea.nomPhPhVoltRMS_G3,
                                  KRK_TwoArea.nomFreq_G3, KRK_TwoArea.Xpd,
                                  KRK_TwoArea.H_G3, KRK_TwoArea.Rs, 10.0);
  ...
  // Xpd is given in p.u of generator base at transfomer primary side and should be transformed to network side
  gen4SP->setStandardParametersPU(KRK_TwoArea.nomPower_G4,
                                  KRK_TwoArea.nomPhPhVoltRMS_G4,
                                  KRK_TwoArea.nomFreq_G4, KRK_TwoArea.Xpd,
                                  KRK_TwoArea.H_G4, KRK_TwoArea.Rs, 10.0);
  ...
  trafo15SP->setParameters(voltageMVSide, voltageHVSide, trafoPower,
                           std::abs(ratio), std::arg(ratio), trafoResistance,
                           trafoInductance);

  auto trafo26SP = SP::Ph1::Transformer::make("trafo26", Logger::Level::debug);
  trafo26SP->setParameters(voltageMVSide, voltageHVSide, trafoPower,
                           std::abs(ratio), std::arg(ratio), trafoResistance,
                           trafoInductance);

  auto trafo311SP =
      SP::Ph1::Transformer::make("trafo311", Logger::Level::debug);
  trafo311SP->setParameters(voltageMVSide, voltageHVSide, trafoPower,
                            std::abs(ratio), std::arg(ratio), trafoResistance,
                            trafoInductance);

  auto trafo410SP =
      SP::Ph1::Transformer::make("trafo410", Logger::Level::debug);
  trafo410SP->setParameters(voltageMVSide, voltageHVSide, trafoPower,
                            std::abs(ratio), std::arg(ratio), trafoResistance,
                            trafoInductance);
  ...
  auto systemSP = SystemTopology(
      ...
      SystemNodeList{n1SP, n2SP, n3SP, n4SP, n5SP, n6SP, n7SP, n8SP, n9SP,
                     n10SP, n11SP},
      SystemComponentList{gen1SP, gen2SP, gen3SP, gen4SP, trafo15SP, trafo26SP,
                          trafo311SP, trafo410SP, load7SP, load9SP, line56SP,
                          line67SP, line78_1SP, line78_2SP, line89_1SP,
                          line89_2SP, line910SP, line1011SP});
  ...
  loggerSP->logAttribute("wref_gen4", gen4SP->attribute("w_ref"));
