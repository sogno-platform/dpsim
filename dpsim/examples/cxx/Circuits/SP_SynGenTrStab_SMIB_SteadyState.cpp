...
void SP_1ph_SynGenTrStab_SteadyState(String simName, Real timeStep,
                                     Real finalTime, Real cmdInertia,
                                     Real cmdDamping) {
  ...
  lineSP->setParameters(smib.lineResistance, smib.lineInductance,
                        smib.lineCapacitance, smib.lineConductance);
  ...
  auto systemSP = SystemTopology(60, SystemNodeList{n1SP, n2SP},
...
int main(int argc, char *argv[]) {
  ...
  SP_1ph_SynGenTrStab_SteadyState(simName, timeStep, finalTime, cmdInertia,
                                  cmdDamping);
}
