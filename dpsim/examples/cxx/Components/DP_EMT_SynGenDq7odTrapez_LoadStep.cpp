...
void DP_SynGenDq7odTrapez_LoadStep(Real timeStep, Real finalTime,
  ...
  // Components
  auto gen = CPS::DP::Ph3::SynchronGeneratorDQTrapez::make(
...
void EMT_SynGenDq7odTrapez_LoadStep(Real timeStep, Real finalTime,
                                    Real breakerClosed, String extension = "") {
