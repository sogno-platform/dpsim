...
Real lineConductance =
    8e-2; //change inductance to allow bigger time steps and to stabilize simulation 8e-2(10us)
...
void SP_1ph_SynGenTrStab_Fault(Real timeStep, Real finalTime,
  ...
  genPF->setParameters(ratedApparentPower, ratedVoltage, setPointActivePower,
  ...
  linePF1->setParameters(lineResistance, lineInductance, lineCapacitance,
                         lineConductance);
  linePF1->setBaseVoltage(Vnom);
  //Line21
  auto linePF21 = SP::Ph1::PiLine::make("PiLine21", Logger::Level::debug);
  linePF21->setParameters(lineResistance21, lineInductance21, lineCapacitance21,
                          lineConductance21);
  linePF21->setBaseVoltage(Vnom);
  //Line22
  auto linePF22 = SP::Ph1::PiLine::make("PiLine22", Logger::Level::debug);
  linePF22->setParameters(lineResistance22, lineInductance22, lineCapacitance22,
                          lineConductance22);
  ...
  line1->setParameters(lineResistance, lineInductance, lineCapacitance,
                       lineConductance);
  line1->setBaseVoltage(Vnom);
  //Line21
  auto line21 = SP::Ph1::PiLine::make("PiLine21", Logger::Level::debug);
  line21->setParameters(lineResistance21, lineInductance21, lineCapacitance21,
                        lineConductance21);
  line21->setBaseVoltage(Vnom);
  //Line22
  auto line22 = SP::Ph1::PiLine::make("PiLine22", Logger::Level::debug);
  line22->setParameters(lineResistance22, lineInductance22, lineCapacitance22,
                        lineConductance22);
