...
int main(int argc, char *argv[]) {
  ...
  Component::Ptr gen2 = SynchronGeneratorVBRNew::make(
  ...
  SystemComponentList comps = {
      ...
      LineR32, LineL12, LineL22, LineL32, Res12,  Res22,  Res32};
  //SystemComponentList comps = { gen, LineR1, LineR2, LineR3, LineL1, LineL2, LineL3, r1, r2, r3, Res1, Res2, Res3 };
  ...
  SystemComponentList compsBreakerOn = {
      ...
      Res22,   Res32,   rBreaker1, rBreaker2, rBreaker3,
  };

  String mSimulationName =
      "DP_SynchronGenerator_VBR_Multimachine" + std::to_string(dt);
  ...
  auto genPtr2 =
      std::dynamic_pointer_cast<DP::Ph3SynchronGeneratorVBRNew>(gen2);
