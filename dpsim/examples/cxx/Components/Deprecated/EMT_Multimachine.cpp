...
int main(int argc, char *argv[]) {
  ...
  Component::Ptr gen2 = SynchronGeneratorVBR::make(
  ...
  system.mComponents = {gen,     gen2,    LineR1,  LineR2,  LineR3,  LineL1,
                        LineL2,  LineL3,  r1,      r2,      r3,      Res1,
                        Res2,    Res3,    LineR12, LineR22, LineR32, LineL12,
                        LineL22, LineL32, Res12,   Res22,   Res32};
  ...
  String mSimulationName =
      "EMT_SynchronGenerator_VBR_Multimachine" + std::to_string(dt);
  ...
  auto genPtr2 =
      std::dynamic_pointer_cast<EMT::Ph3::SynchronGeneratorVBR>(gen2);
