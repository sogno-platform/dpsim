...
int main(int argc, char *argv[]) {
  ...
  Component::Ptr gen = SynchronGenerator::make(
      mGeneratorName, 0, 1, 2, nomPower, nomPhPhVoltRMS, nomFreq, poleNum,
      nomFieldCurr, Rs, Ll, Lmd, Lmd0, Lmq, Lmq0, Rfd, Llfd, Rkd, Llkd, Rkq1,
      Llkq1, Rkq2, Llkq2, H, Ra, Logger::Level::info);

  // Declare circuit components
  String mGeneratorName2 = "EMT_Dq2_" + std::to_string(dt);
  Component::Ptr gen2 = SynchronGenerator::make(
      mGeneratorName2, 12, 13, 14, nomPower, nomPhPhVoltRMS, nomFreq, poleNum,
      nomFieldCurr, Rs, Ll, Lmd, Lmd0, Lmq, Lmq0, Rfd, Llfd, Rkd, Llkd, Rkq1,
      Llkq1, Rkq2, Llkq2, H, Ra, Logger::Level::info);
  ...
  //Line Inductance
  Component::Ptr LineL1 =
      Inductor::make("LineL1", 3, 6, lindeInd, -1743.9006140981385, 3404);
  Component::Ptr LineL2 =
      Inductor::make("LineL2", 4, 7, lindeInd, -7551.1645960101869, -2231);
  Component::Ptr LineL3 =
      Inductor::make("LineL3", 5, 8, lindeInd, 9295.0652101083233, -1174);
  ...
  //Line Inductance2
  Component::Ptr LineL12 =
      Inductor::make("LineL12", 6, 9, lindeInd, 1743.9006140981385, -3404);
  Component::Ptr LineL22 =
      Inductor::make("LineL22", 7, 10, lindeInd, 7551.1645960101869, 2231);
  Component::Ptr LineL32 =
      Inductor::make("LineL32", 8, 11, lindeInd, -9295.0652101083233, 1174);
  ...
  SystemComponentList comps = {
      gen,     gen2,    LineR1,  LineR2,  LineR3, LineL1, LineL2,  LineL3,
      r1,      r2,      r3,      Res1,    Res2,   Res3,   LineR12, LineR22,
      LineR32, LineL12, LineL22, LineL32, Res12,  Res22,  Res32,   Rsn1,
      Rsn2,    Rsn3,    Rsn4,    Rsn5,    Rsn6};
  ...
  SystemComponentList compsBreakerOn = {
      gen,     gen2,    LineR1,    LineR2,    LineR3,    LineL1,  LineL2,
      LineL3,  r1,      r2,        r3,        Res1,      Res2,    Res3,
      LineR12, LineR22, LineR32,   LineL12,   LineL22,   LineL32, Res12,
      Res22,   Res32,   rBreaker1, rBreaker2, rBreaker3, Rsn1,    Rsn2,
      Rsn3,    Rsn4,    Rsn5,      Rsn6};
  ...
  genPtr2->initialize(om, dt, initActivePower, initReactivePower,
                      initTerminalVolt, initVoltAngle, mechPower);
  genPtr2->AddExciter(Ta, Ka, Te, Ke, Tf, Kf, Tr, Lmd, Rfd);
  genPtr2->AddGovernor(Ta_t, Tb, Tc, Fa, Fb, Fc, Kg, Tsr, Tsm,
                       initActivePower / nomPower, mechPower / nomPower);
