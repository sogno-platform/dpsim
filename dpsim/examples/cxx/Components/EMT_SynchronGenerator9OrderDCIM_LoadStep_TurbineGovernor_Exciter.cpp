...
int main(int argc, char *argv[]) {
  ...
  String simName =
      "EMT_Ph3_SynchronGenerator9OrderDCIM_LoadStep_TurbineGovernor_Exciter";
  Real timeStep = 50e-6;
  Real finalTime = 1.0;
  ...
  gen->setParametersFundamentalPerUnit(
      ...
      cmdInertiaFactor * syngenKundur.H, initActivePower, initReactivePower,
      initTerminalVoltageMagnitude, initTerminalVoltageAngle, initMechPower);
