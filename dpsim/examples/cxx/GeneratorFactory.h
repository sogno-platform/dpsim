...
std::shared_ptr<SP::Ph1::ReducedOrderSynchronGeneratorVBR> createGenSP(const String& SGModel, const String & name, Logger::Level logLevel) { 
...
std::shared_ptr<DP::Ph1::ReducedOrderSynchronGeneratorVBR> createGenDP(const String& SGModel, const String & name, Logger::Level logLevel) { 
...
std::shared_ptr<EMT::Ph3::ReducedOrderSynchronGeneratorVBR> createGenEMT(const String& SGModel, const String & name, Logger::Level logLevel) { 
