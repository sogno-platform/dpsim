...
void addBaseComponents(py::module_ mBase) {
    ...
    py::class_<CPS::Base::ReducedOrderSynchronGenerator<CPS::Complex>, std::shared_ptr<CPS::Base::ReducedOrderSynchronGenerator<CPS::Complex>>, CPS::SimPowerComp<CPS::Complex>>(mBase, "ReducedOrderSynchronGeneratorComplex", py::multiple_inheritance())
		...
		.def("set_model_as_norton_source", &CPS::Base::ReducedOrderSynchronGenerator<CPS::Complex>::setModelAsNortonSource, "model_as_norton_source"_a).def("add_exciter", py::overload_cast<std::shared_ptr<CPS::Base::ExciterParameters>, CPS::ExciterType>(&CPS::Base::ReducedOrderSynchronGenerator<CPS::Complex>::addExciter), "exciter_parameters"_a, "exciter_type"_a=CPS::ExciterType::DC1Simp)
		.def("add_pss", py::overload_cast<CPS::Real, CPS::Real, CPS::Real, CPS::Real, CPS::Real, CPS::Real, CPS::Real, CPS::Real, CPS::Real, CPS::Real>(&CPS::Base::ReducedOrderSynchronGenerator<CPS::Complex>::addPSS), "Kp"_a, "Kv"_a, "Kw"_a, "T1"_a, "T2"_a, "T3"_a, "T4"_a, "Vs_max"_a, "Vs_min"_a, "Tw"_a)
    ...
    py::class_<CPS::Base::ReducedOrderSynchronGenerator<CPS::Real>, std::shared_ptr<CPS::Base::ReducedOrderSynchronGenerator<CPS::Real>>, CPS::SimPowerComp<CPS::Real>>(mBase, "ReducedOrderSynchronGeneratorReal", py::multiple_inheritance())
        ...
        .def("add_exciter", py::overload_cast<std::shared_ptr<CPS::Base::ExciterParameters>, CPS::ExciterType>(&CPS::Base::ReducedOrderSynchronGenerator<CPS::Real>::addExciter), "exciter_parameters"_a, "exciter_type"_a=CPS::ExciterType::DC1Simp)
		.def("add_pss", py::overload_cast<CPS::Real, CPS::Real, CPS::Real, CPS::Real, CPS::Real, CPS::Real, CPS::Real, CPS::Real, CPS::Real, CPS::Real>(&CPS::Base::ReducedOrderSynchronGenerator<CPS::Real>::addPSS), "Kp"_a, "Kv"_a, "Kw"_a, "T1"_a, "T2"_a, "T3"_a, "T4"_a, "Vs_max"_a, "Vs_min"_a, "Tw"_a)
