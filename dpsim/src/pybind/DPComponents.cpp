...
void addDPPh1Components(py::module_ mDPPh1)
{
	...
	py::class_<CPS::DP::Ph1::SynchronGeneratorTrStab, std::shared_ptr<CPS::DP::Ph1::SynchronGeneratorTrStab>, CPS::SimPowerComp<CPS::Complex>>(mDPPh1, "SynchronGeneratorTrStab", py::multiple_inheritance())
		...
		.def(
			"set_reference_omega", [](CPS::DP::Ph1::SynchronGeneratorTrStab &gen, std::string refOmegaName, CPS::IdentifiedObject::Ptr refOmegaComp, std::string refDeltaName, CPS::IdentifiedObject::Ptr refDeltaComp)
	...
	py::class_<CPS::DP::Ph1::VSIVoltageControlVBR, std::shared_ptr<CPS::DP::Ph1::VSIVoltageControlVBR>, CPS::SimPowerComp<CPS::Complex>, CPS::Base::VSIVoltageSourceInverterDQ<CPS::Complex>>(mDPPh1, "VSIVoltageControlVBR", py::multiple_inheritance())
		.def(py::init<std::string, CPS::Logger::Level>(), "name"_a, "loglevel"_a = CPS::Logger::Level::off)
