...
void addDPComponents(py::module_ mDP) {
  py::class_<CPS::DP::SimNode, std::shared_ptr<CPS::DP::SimNode>,
      ...
      .def("set_initial_voltage",
           py::overload_cast<CPS::Complex>(&CPS::DP::SimNode::setInitialVoltage,
                                           py::const_))
      .def("set_initial_voltage",
  ...
  py::module mDPPh1 =
      mDP.def_submodule("ph1", "single phase dynamic phasor models");
  addDPPh1Components(mDPPh1);

  py::module mDPPh3 =
      mDP.def_submodule("ph3", "triple phase dynamic phasor models");
...
void addDPPh1Components(py::module_ mDPPh1) {
  ...
  py::class_<CPS::DP::Ph1::VoltageSourceNorton,
  ...
  py::class_<CPS::DP::Ph1::NetworkInjection,
             std::shared_ptr<CPS::DP::Ph1::NetworkInjection>,
  ...
  py::class_<CPS::DP::Ph1::SynchronGeneratorTrStab,
      ...
      .def(
          "set_reference_omega",
          [](CPS::DP::Ph1::SynchronGeneratorTrStab &gen,
             std::string refOmegaName, CPS::IdentifiedObject::Ptr refOmegaComp,
             std::string refDeltaName,
             CPS::IdentifiedObject::Ptr refDeltaComp) {
            gen.setReferenceOmega(
                refOmegaComp->attributeTyped<CPS::Real>(refOmegaName),
                refDeltaComp->attributeTyped<CPS::Real>(refDeltaName));
          },
	...
	py::class_<CPS::DP::Ph1::ReducedOrderSynchronGeneratorVBR, std::shared_ptr<CPS::DP::Ph1::ReducedOrderSynchronGeneratorVBR>, CPS::Base::ReducedOrderSynchronGenerator<CPS::Complex>>(mDPPh1, "ReducedOrderSynchronGeneratorVBR", py::multiple_inheritance())
		...
		.def("add_exciter", py::overload_cast<std::shared_ptr<CPS::Base::ExciterParameters>, CPS::ExciterType>(&CPS::DP::Ph1::ReducedOrderSynchronGeneratorVBR::addExciter), "exciter_parameters"_a, "exciter_type"_a=CPS::ExciterType::DC1Simp)
  ...
  py::class_<CPS::DP::Ph1::SynchronGenerator3OrderVBR,
      ...
      .def("set_operational_parameters_per_unit",
           py::overload_cast<CPS::Real, CPS::Real, CPS::Real, CPS::Real,
                             ...
                             CPS::Real>(
               &CPS::DP::Ph1::SynchronGenerator3OrderVBR::
  ...
  py::class_<CPS::DP::Ph1::SynchronGenerator4OrderVBR,
      ...
      .def("set_operational_parameters_per_unit",
           py::overload_cast<CPS::Real, CPS::Real, CPS::Real, CPS::Real,
               ...
               &CPS::DP::Ph1::SynchronGenerator4OrderVBR::
                   setOperationalParametersPerUnit),
           "nom_power"_a, "nom_voltage"_a, "nom_frequency"_a, "H"_a, "Ld"_a,
  ...
  py::class_<CPS::DP::Ph1::SynchronGenerator5OrderVBR,
      ...
      .def("set_operational_parameters_per_unit",
           py::overload_cast<CPS::Real, CPS::Real, CPS::Real, CPS::Real,
                             ...
                             CPS::Real, CPS::Real, CPS::Real, CPS::Real,
                             CPS::Real, CPS::Real, CPS::Real, CPS::Real>(
               &CPS::DP::Ph1::SynchronGenerator5OrderVBR::
                   setOperationalParametersPerUnit),
           "nom_power"_a, "nom_voltage"_a, "nom_frequency"_a, "H"_a, "Ld"_a,
  ...
  py::class_<CPS::DP::Ph1::SynchronGenerator6aOrderVBR,
      ...
      .def("set_operational_parameters_per_unit",
           py::overload_cast<CPS::Real, CPS::Real, CPS::Real, CPS::Real,
                             ...
                             CPS::Real, CPS::Real, CPS::Real, CPS::Real,
                             CPS::Real, CPS::Real, CPS::Real, CPS::Real>(
               &CPS::DP::Ph1::SynchronGenerator6aOrderVBR::
                   setOperationalParametersPerUnit),
           "nom_power"_a, "nom_voltage"_a, "nom_frequency"_a, "H"_a, "Ld"_a,
           "Lq"_a, "L0"_a, "Ld_t"_a, "Lq_t"_a, "Td0_t"_a, "Tq0_t"_a, "Ld_s"_a,
           "Lq_s"_a, "Td0_s"_a, "Tq0_s"_a, "Taa"_a)
  ...
  py::class_<CPS::DP::Ph1::SynchronGenerator6bOrderVBR,
      ...
      .def("set_operational_parameters_per_unit",
           py::overload_cast<CPS::Real, CPS::Real, CPS::Real, CPS::Real,
                             ...
                             CPS::Real, CPS::Real, CPS::Real, CPS::Real,
                             CPS::Real, CPS::Real, CPS::Real, CPS::Real>(
               &CPS::DP::Ph1::SynchronGenerator6bOrderVBR::
                   setOperationalParametersPerUnit),
           "nom_power"_a, "nom_voltage"_a, "nom_frequency"_a, "H"_a, "Ld"_a,
           "Lq"_a, "L0"_a, "Ld_t"_a, "Lq_t"_a, "Td0_t"_a, "Tq0_t"_a, "Ld_s"_a,
  ...
  py::class_<CPS::DP::Ph1::AvVoltageSourceInverterDQ,
      ...
      .def("set_filter_parameters",
           &CPS::DP::Ph1::AvVoltageSourceInverterDQ::setFilterParameters,
           "Lf"_a, "Cf"_a, "Rf"_a, "Rc"_a)
      .def("set_controller_parameters",
           &CPS::DP::Ph1::AvVoltageSourceInverterDQ::setControllerParameters,
      ...
      .def("set_transformer_parameters",
           &CPS::DP::Ph1::AvVoltageSourceInverterDQ::setTransformerParameters,
      ...
      .def("set_initial_state_values",
           &CPS::DP::Ph1::AvVoltageSourceInverterDQ::setInitialStateValues,
...
void addDPPh3Components(py::module_ mDPPh3) {
  ...
  py::class_<CPS::DP::Ph3::SynchronGeneratorDQODE,
             std::shared_ptr<CPS::DP::Ph3::SynchronGeneratorDQODE>,
  ...
  py::class_<CPS::DP::Ph3::SynchronGeneratorDQTrapez,
             std::shared_ptr<CPS::DP::Ph3::SynchronGeneratorDQTrapez>,
             CPS::SimPowerComp<CPS::Complex>>(
