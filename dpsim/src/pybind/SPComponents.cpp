...
void addSPPh1Components(py::module_ mSPPh1)
{
	...
	py::class_<CPS::SP::Ph1::Load, std::shared_ptr<CPS::SP::Ph1::Load>, CPS::SimPowerComp<CPS::Complex>>(mSPPh1, "Load", py::multiple_inheritance())
		.def(py::init<std::string, CPS::Logger::Level>(), "name"_a, "loglevel"_a = CPS::Logger::Level::off)
		.def("set_parameters", py::overload_cast<CPS::Real, CPS::Real>(&CPS::SP::Ph1::Load::setParameters), "active_power"_a, "reactive_power"_a)
	...
	py::class_<CPS::SP::Ph1::SynchronGeneratorTrStab, std::shared_ptr<CPS::SP::Ph1::SynchronGeneratorTrStab>, CPS::SimPowerComp<CPS::Complex>>(mSPPh1, "SynchronGeneratorTrStab", py::multiple_inheritance())
		...
		.def(
			"set_reference_omega", [](CPS::SP::Ph1::SynchronGeneratorTrStab &gen, std::string refOmegaName, CPS::IdentifiedObject::Ptr refOmegaComp, std::string refDeltaName, CPS::IdentifiedObject::Ptr refDeltaComp)
	...
	py::class_<CPS::SP::Ph1::VSIVoltageControlVBR, std::shared_ptr<CPS::SP::Ph1::VSIVoltageControlVBR>, CPS::SimPowerComp<CPS::Complex>, CPS::Base::VSIVoltageSourceInverterDQ<CPS::Complex>>(mSPPh1, "VSIVoltageControlVBR", py::multiple_inheritance())
		.def(py::init<std::string, CPS::Logger::Level>(), "name"_a, "loglevel"_a = CPS::Logger::Level::off)
