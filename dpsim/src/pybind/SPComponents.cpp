...
void addSPComponents(py::module_ mSP) {
  py::module mSPPh1 =
      mSP.def_submodule("ph1", "single phase static phasor models");
  addSPPh1Components(mSPPh1);
  py::module mSPPh3 =
      mSP.def_submodule("ph3", "three phase static phasor models");
...
void addSPPh1Components(py::module_ mSPPh1) {
  ...
  py::class_<CPS::SP::Ph1::PiLine, std::shared_ptr<CPS::SP::Ph1::PiLine>,
  ...
  py::class_<CPS::SP::Ph1::SynchronGeneratorTrStab,
      ...
      .def(
          "set_reference_omega",
          [](CPS::SP::Ph1::SynchronGeneratorTrStab &gen,
  ...
  py::class_<CPS::SP::Ph1::SynchronGenerator5OrderVBR,
      ...
      .def("set_operational_parameters_per_unit",
           py::overload_cast<CPS::Real, CPS::Real, CPS::Real, CPS::Real,
                             ...
                             CPS::Real, CPS::Real, CPS::Real, CPS::Real,
                             CPS::Real, CPS::Real, CPS::Real, CPS::Real>(
               &CPS::SP::Ph1::SynchronGenerator5OrderVBR::
                   setOperationalParametersPerUnit),
           "nom_power"_a, "nom_voltage"_a, "nom_frequency"_a, "H"_a, "Ld"_a,
  ...
  py::class_<CPS::SP::Ph1::SynchronGenerator6aOrderVBR,
      ...
      .def("set_operational_parameters_per_unit",
           py::overload_cast<CPS::Real, CPS::Real, CPS::Real, CPS::Real,
                             ...
                             CPS::Real, CPS::Real, CPS::Real, CPS::Real,
                             CPS::Real, CPS::Real, CPS::Real, CPS::Real>(
               &CPS::SP::Ph1::SynchronGenerator6aOrderVBR::
                   setOperationalParametersPerUnit),
           "nom_power"_a, "nom_voltage"_a, "nom_frequency"_a, "H"_a, "Ld"_a,
           "Lq"_a, "L0"_a, "Ld_t"_a, "Lq_t"_a, "Td0_t"_a, "Tq0_t"_a, "Ld_s"_a,
           "Lq_s"_a, "Td0_s"_a, "Tq0_s"_a, "Taa"_a)
  ...
  py::class_<CPS::SP::Ph1::SynchronGenerator6bOrderVBR,
      ...
      .def("set_operational_parameters_per_unit",
           py::overload_cast<CPS::Real, CPS::Real, CPS::Real, CPS::Real,
                             ...
                             CPS::Real, CPS::Real, CPS::Real, CPS::Real,
                             CPS::Real, CPS::Real, CPS::Real, CPS::Real>(
               &CPS::SP::Ph1::SynchronGenerator6bOrderVBR::
                   setOperationalParametersPerUnit),
           "nom_power"_a, "nom_voltage"_a, "nom_frequency"_a, "H"_a, "Ld"_a,
           "Lq"_a, "L0"_a, "Ld_t"_a, "Lq_t"_a, "Td0_t"_a, "Tq0_t"_a, "Ld_s"_a,
  ...
  py::class_<CPS::SP::Ph1::AvVoltageSourceInverterDQ,
      ...
      .def("set_filter_parameters",
           &CPS::SP::Ph1::AvVoltageSourceInverterDQ::setFilterParameters,
           "Lf"_a, "Cf"_a, "Rf"_a, "Rc"_a)
      .def("set_controller_parameters",
           &CPS::SP::Ph1::AvVoltageSourceInverterDQ::setControllerParameters,
  ...
  py::class_<CPS::SP::Ph1::Transformer,
      ...
      .def("set_reference_winding",
           &CPS::SP::Ph1::Transformer::setReferenceWinding,
           "reference_winding"_a)
      .def("set_magnetizing_branch",
           &CPS::SP::Ph1::Transformer::setMagnetizingBranch,
           "no_load_current"_a, "no_load_loss"_a)
      .def("connect", &CPS::SP::Ph1::Transformer::connect);
}

void addSPPh3Components(py::module_ mSPPh3) {
  py::class_<CPS::SP::Ph3::Transformer,
             std::shared_ptr<CPS::SP::Ph3::Transformer>,
             CPS::SimPowerComp<CPS::Complex>>(mSPPh3, "Transformer",
                                              py::multiple_inheritance())
      .def(py::init<std::string, CPS::Logger::Level>(), "name"_a,
           "loglevel"_a = CPS::Logger::Level::off)
      .def(py::init<std::string, std::string, CPS::Logger::Level, CPS::Bool>(),
           ...
           // cppcheck-suppress assignBoolToPointer
           "with_resistive_losses"_a = false)
      .def("set_parameters", &CPS::SP::Ph3::Transformer::setParameters,
           "nom_voltage_primary"_a, "nom_voltage_secondary"_a, "rated_power"_a,
           "ratio_abs"_a, "ratio_phase"_a, "resistance"_a, "inductance"_a)
      .def("set_reference_winding",
           &CPS::SP::Ph3::Transformer::setReferenceWinding,
           "reference_winding"_a)
      .def("set_magnetizing_branch",
           &CPS::SP::Ph3::Transformer::setMagnetizingBranch,
           "no_load_current"_a, "no_load_loss"_a)
      .def("connect", &CPS::SP::Ph3::Transformer::connect);

  py::class_<CPS::SP::Ph3::VoltageSource,
