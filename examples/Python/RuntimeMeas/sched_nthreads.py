...
def sched_nthreads(instance, threads, schedulers, size):
    ...
    for scheduler in schedulers:
        ...
        for n in threads:
            ...
            args['threads'] = n
            avg, sigma = instance.do_sim(scheduler=sched_name, scheduler_args=args, size=size)
...
if __name__ == '__main__':
    ...
    instance = SimInstance(name, glob.glob('../dpsim/examples/CIM/WSCC-09_RX_Dyn/*.xml'), 60.0, 50)
    instance.sim_args = {
        'timestep': 0.0001,
        'duration': 0.1,
