...
# of the PQ load. The n2 voltage is exported to a file via InterfaceVillas.
...
def dpsim():
    ...
    intf2 = dpsimpyvillas.InterfaceVillas(name="dpsim-shmem", node_type="shmem", config=intf_config_2)
