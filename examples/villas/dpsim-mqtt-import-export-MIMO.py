...
def villas():
    ...
    nodes = {
        ...
        "shmem": {
            ...
            "out": {"name": "/shmem-dpsim"},
        },
        "file1": {"type": "file", "uri": f"{base}-results-%y-%m-%d_%H_%M_%S.csv"},
        "file2": {"type": "file", "uri": f"{base}-results-%y-%m-%d_%H_%M_%S_2.csv"},
        "sine": {
            "type": "signal",
            "signal": "sine",
            "rate": 10,
    ...
    paths = [
        ...
        {"in": "shmem", "out": "file2", "hooks": [{"type": "print"}]},
        {"in": "sine", "out": ["mqtt", "shmem"], "hooks": [{"type": "print"}]},
    ]
...
def dpsim():
    ...
    intf2 = dpsimpyvillas.InterfaceVillas(
        name="dpsim-shmem", config=json.dumps(intf_config_2)
    )
